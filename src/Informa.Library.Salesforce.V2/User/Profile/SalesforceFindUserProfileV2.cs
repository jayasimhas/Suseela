    ...
    public class SalesforceFindUserProfileV2 : ISalesforceFindUserProfileV2, IUserProfileFactory, IFindUserProfileByUsernameV2
    {
        ...
        public ISalesforceUserProfile Find(string accessToken)
        {
            ...
            return new SalesforceUserProfile
            {
                ...
                BillAddress1 = addresses.Length >= 1 ? addresses[0] : string.Empty,
                BillAddress2 = addresses.Length >= 2 ? addresses[1] : string.Empty,
                ...
                ShipAddress1 = addresses.Length >= 1 ? addresses[0] : string.Empty,
                ShipAddress2 = addresses.Length >= 2 ? addresses[1] : string.Empty,
                ...
                CountryCode = contactNumerDeatils.Length >= 1 ? contactNumerDeatils[0] : string.Empty,
                Phone = contactNumerDeatils.Length >= 2 ? contactNumerDeatils[1] : string.Empty,
                PhoneExtension = contactNumerDeatils.Length >= 3 ? contactNumerDeatils[2] : string.Empty,
                Fax = string.Empty,
