        ...
        <div class="Section">
            <div class="Controls">
			    <div class="formRow">
                    ...
                    <%--<asp:Button ID="btnPublishImported" Text="Publish Imported Items" OnClick="btnPublishImported_Click" runat="server" BackColor="#474747" ForeColor="White" BorderWidth="0" Width="150px" Height="30px" />--%>
                </div>
