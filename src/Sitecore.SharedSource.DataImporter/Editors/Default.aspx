        ...
        <div class="Section">
            <div class="Controls">
			    <div class="formRow">
					...
					<asp:Button ID="btnArticleRemove" Text="Run Article Removal" OnClick="btnArticleRemove_Click" runat="server" BackColor="#474747" ForeColor="White" BorderWidth="0" Width="120px" Height="30px"  />
