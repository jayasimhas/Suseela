...
{
	public class ArticleRemovalProcessor
    {
		...
		public ArticleRemovalProcessor(IDataMap dm, ILogger l)
		{
			if (dm == null)
      ...
      /// <summary>
        ...
        public void ArticleRemovalProcess(IDataMap map)
        {
