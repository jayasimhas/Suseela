...
{
	public class SearchMediaIconField : BaseGlassComputedField<IArticle>
	{
		public override object GetFieldValue(IArticle indexItem)
		{
			...
			return indexItem.Media_Type?.Item_Name == "Data" ? "chart" : indexItem.Media_Type?.Item_Name?.ToLower() ?? "";
		}
	}
}