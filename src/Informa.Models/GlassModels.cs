...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components
{
 	...
 	/// <summary>
	/// IVideo_Control Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Components/Video Control</para>	
	/// <para>ID: 00dc502a-7fcf-4160-86bf-b8eb1c15cba1</para>	
	/// </summary>
	[SitecoreType(TemplateId=IVideo_ControlConstants.TemplateIdString)]
	public partial interface IVideo_Control : IGlassBase 
	{
								/// <summary>
					/// The AlternativeText field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 1fc1398f-3081-4190-997a-708fe0c0a73b</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IVideo_ControlConstants.AlternativeTextFieldName, Setting = SitecoreFieldSettings.InferType)]
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IVideo_ControlConstants.ThumbnailFieldName, Setting = SitecoreFieldSettings.InferType)]
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IVideo_ControlConstants.VideoLinkFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		/// </summary>
		[SitecoreType]
		public partial interface IVideo_Control__Raw : IGlassBase 
		{
										/// <summary>
						/// The AlternativeText field.
						/// <para></para>
	...
	public static partial class IVideo_ControlConstants{
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Properties
{


 	/// <summary>
	/// IUrlToText Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Mappings/Properties/UrlToText</para>	
	/// <para>ID: 0348e554-4e39-4cde-a1b7-5a7e6e80e712</para>	
	/// </summary>
	[SitecoreType(TemplateId=IUrlToTextConstants.TemplateIdString)]
	public partial interface IUrlToText : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.IBase_Mapping
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IUrlToText__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.IBase_Mapping__Raw
		{
						}
	
	public static partial class IUrlToTextConstants{

			public const string TemplateIdString = "0348e554-4e39-4cde-a1b7-5a7e6e80e712";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "UrlToText";

					
			public static readonly ID To_What_FieldFieldId = new ID("093d915a-4306-4a68-b64a-07cc2a7e4ee5");
			public const string To_What_FieldFieldName = "To What Field";

						
					
			public static readonly ID Handler_AssemblyFieldId = new ID("bdf8732c-c239-4762-a3e0-ada23ef44775");
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages
{
 	...
 	/// <summary>
	/// IRegistration_Details_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Registration Details Page</para>	
	/// <para>ID: 0520d52b-52a8-4052-a07f-9f35f8ca274c</para>	
	/// </summary>
	[SitecoreType(TemplateId=IRegistration_Details_PageConstants.TemplateIdString)]
	public partial interface IRegistration_Details_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.IRegistration_Page
	{
					...
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 761d17cf-74db-4658-ad8b-3c3b119d5851</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IRegistration_Details_PageConstants.Newsletter_Sign_Up_TextFieldName, Setting = SitecoreFieldSettings.InferType)]
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IRegistration_Details_PageConstants.Next_Step_PageFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid Next_Step_Page  {get; set;}
								/// <summary>
					/// The User Agreement Text field.
					/// <para></para>
					/// <para>Field Type: Rich Text</para>		
					/// <para>Field ID: cd6cd5e9-9d91-4d09-b981-e9e3c8d9b391</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IRegistration_Details_PageConstants.User_Agreement_TextFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		public partial interface IRegistration_Details_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.IRegistration_Page__Raw
		{
						...
						/// <para>Custom Data: </para>
						/// </summary>
						[SitecoreField(IRegistration_Details_PageConstants.User_Agreement_TextFieldName, Setting = SitecoreFieldSettings.RichTextRaw)]
						string User_Agreement_Text  {get; set;}
						}
	
	public static partial class IRegistration_Details_PageConstants{

			public const string TemplateIdString = "0520d52b-52a8-4052-a07f-9f35f8ca274c";
			public static readonly ID TemplateId = new ID(TemplateIdString);
...
namespace Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned
{
	...
	/// IPdf Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/System/Media/Unversioned/Pdf</para>	
	/// <para>ID: 0603f166-35b8-469f-8123-e8d87bedc171</para>	
	/// </summary>
	[SitecoreType(TemplateId=IPdfConstants.TemplateIdString)]
	public partial interface IPdf : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned.IDocument
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IPdf__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned.IDocument__Raw
		{
						}
	
	public static partial class IPdfConstants{

			public const string TemplateIdString = "0603f166-35b8-469f-8123-e8d87bedc171";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Pdf";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.Account
{
 	...
 	/// <summary>
	/// ISaved_Articles_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Account/Saved Articles Page</para>	
	/// <para>ID: 0807607f-2431-41bb-b56a-19ab73b0928c</para>	
	/// </summary>
	...
	public static partial class ISaved_Articles_PageConstants{
			...
			public const string TemplateIdString = "0807607f-2431-41bb-b56a-19ab73b0928c";
			public static readonly ID TemplateId = new ID(TemplateIdString);
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields
{
	...
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Mappings/Fields/UrlToReference</para>	
	/// <para>ID: 0f528c70-e771-4f2f-8d80-103a57104519</para>	
	/// </summary>
	[SitecoreType(TemplateId=IUrlToReferenceConstants.TemplateIdString)]
	public partial interface IUrlToReference : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields.IToText
	{
								/// <summary>
					/// The SiteHomeItem field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: c521a3fc-e04f-4dc8-9ad5-8ac2c4e365ff</para>
					/// <para>Custom Data: </para>
					/// </summary>
		...
		/// </summary>
		[SitecoreType]
		public partial interface IUrlToReference__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields.IToText__Raw
		{
										/// <summary>
						/// The SiteHomeItem field.
						/// <para></para>
	...
	public static partial class IUrlToReferenceConstants{

			public const string TemplateIdString = "0f528c70-e771-4f2f-8d80-103a57104519";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "UrlToReference";

					
			public static readonly ID SiteHomeItemFieldId = new ID("c521a3fc-e04f-4dc8-9ad5-8ac2c4e365ff");
			public const string SiteHomeItemFieldName = "SiteHomeItem";

						
					
			public static readonly ID DelimiterFieldId = new ID("ebb47640-52e2-4bc3-8231-af6fc5113da3");
			public const string DelimiterFieldName = "Delimiter";

						
					
			public static readonly ID From_What_FieldsFieldId = new ID("a534b62b-9c6b-449f-8b88-93753efe6aec");
			public const string From_What_FieldsFieldName = "From What Fields";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages
{
 	...
 	/// <summary>
	/// IRegistration_Content_Customization_Page Interface
	/// <para></para>
	...
	/// </summary>
	[SitecoreType(TemplateId=IRegistration_Content_Customization_PageConstants.TemplateIdString)]
	public partial interface IRegistration_Content_Customization_Page : IGlassBase 
*********************************************
An error occured while generating code for item '/sitecore/templates/User Defined/Pages/Registration Content Customization Page'.
T4 Template: D:\INFORMA\TS3\sitecore\Informa.tds.master\Code Generation Templates\glassv3item.tt
Errors:

Running transformation: System.NullReferenceException: Object reference not set to an instance of an object.
   at Microsoft.VisualStudio.TextTemplatingDA4BDB0B164CCB8F190EE018BF1F310F71A72EF6AD8CEBE3443D779EF1E15B1A09E7B547DB17EDDB9B2A59AB08EB25B3A92932D6589F83B12754AA417C2062E0.GeneratedTextTransformation.GetNamespace(String defaultNamespace, SitecoreItem item, Boolean includeGlobal)
   at Microsoft.VisualStudio.TextTemplatingDA4BDB0B164CCB8F190EE018BF1F310F71A72EF6AD8CEBE3443D779EF1E15B1A09E7B547DB17EDDB9B2A59AB08EB25B3A92932D6589F83B12754AA417C2062E0.GeneratedTextTransformation.GetFullyQualifiedName(String defaultNamespace, SitecoreItem item, Func`2 nameFunc)
   at Microsoft.VisualStudio.TextTemplatingDA4BDB0B164CCB8F190EE018BF1F310F71A72EF6AD8CEBE3443D779EF1E15B1A09E7B547DB17EDDB9B2A59AB08EB25B3A92932D6589F83B12754AA417C2062E0.GeneratedTextTransformation.<>c__DisplayClass1_0.<GetObjectInheritanceDefinition>b__0(SitecoreTemplate bt)
   at System.Linq.Enumerable.WhereSelectListIterator`2.MoveNext()
   at System.Linq.Enumerable.Aggregate[TSource](IEnumerable`1 source, Func`3 func)
   at Microsoft.VisualStudio.TextTemplatingDA4BDB0B164CCB8F190EE018BF1F310F71A72EF6AD8CEBE3443D779EF1E15B1A09E7B547DB17EDDB9B2A59AB08EB25B3A92932D6589F83B12754AA417C2062E0.GeneratedTextTransformation.GetObjectInheritanceDefinition(String defaultNamespace, SitecoreTemplate item, Boolean includeLeadingComma, Func`2 nameFunc)
   at Microsoft.VisualStudio.TextTemplatingDA4BDB0B164CCB8F190EE018BF1F310F71A72EF6AD8CEBE3443D779EF1E15B1A09E7B547DB17EDDB9B2A59AB08EB25B3A92932D6589F83B12754AA417C2062E0.GeneratedTextTransformation.TransformText()
...
namespace Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned
{
	...
	/// IDoc Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/System/Media/Unversioned/Doc</para>	
	/// <para>ID: 16692733-9a61-45e6-b0d4-4c0c06f8dd3c</para>	
	/// </summary>
	[SitecoreType(TemplateId=IDocConstants.TemplateIdString)]
	public partial interface IDoc : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned.IDocument
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IDoc__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned.IDocument__Raw
		{
						}
	
	public static partial class IDocConstants{

			public const string TemplateIdString = "16692733-9a61-45e6-b0d4-4c0c06f8dd3c";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Doc";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.Account
{
 	...
 	/// <summary>
	/// ISaved_Searches_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Account/Saved Searches Page</para>	
	/// <para>ID: 1af8707f-0f49-488e-8cdd-264ef385551e</para>	
	/// </summary>
	...
	public static partial class ISaved_Searches_PageConstants{
			...
			public const string TemplateIdString = "1af8707f-0f49-488e-8cdd-264ef385551e";
			public static readonly ID TemplateId = new ID(TemplateIdString);
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content
{
 	...
 	/// <summary>
	/// IContent_Title Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/General Content/Content Title</para>	
	/// <para>ID: 2256d30a-0783-42eb-82c0-6cca66977229</para>	
	/// </summary>
	[SitecoreType(TemplateId=IContent_TitleConstants.TemplateIdString)]
	public partial interface IContent_Title : IGlassBase 
	{
								/// <summary>
					/// The Title field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 5c986baf-5370-43d6-89c6-be1e0595609b</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IContent_TitleConstants.TitleFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		/// </summary>
		[SitecoreType]
		public partial interface IContent_Title__Raw : IGlassBase 
		{
										/// <summary>
						/// The Title field.
						/// <para></para>
	...
	public static partial class IContent_TitleConstants{

			public const string TemplateIdString = "2256d30a-0783-42eb-82c0-6cca66977229";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Content Title";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Configuration
{
 	...
 	/// <summary>
	/// IUser_Lockout_Emails_Config Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Configuration/User Lockout Emails Config</para>	
	/// <para>ID: 27678fc0-f7cb-40eb-bfbf-9c226b62eece</para>	
	/// </summary>
	[SitecoreType(TemplateId=IUser_Lockout_Emails_ConfigConstants.TemplateIdString)]
	public partial interface IUser_Lockout_Emails_Config : IGlassBase 
	{
								/// <summary>
					/// The Lockout Email Body field.
					/// <para></para>
					/// <para>Field Type: Rich Text</para>		
					/// <para>Field ID: cc904647-bac3-4fe2-8884-f6106c487670</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IUser_Lockout_Emails_ConfigConstants.Lockout_Email_BodyFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Lockout_Email_Body  {get; set;}
								/// <summary>
					/// The Lockout Email From field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 742c887c-86c6-4d36-b5cf-bb3ba50f49c4</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IUser_Lockout_Emails_ConfigConstants.Lockout_Email_FromFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Lockout_Email_From  {get; set;}
								/// <summary>
					/// The Lockout Email Subject field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: d2c6a078-8cb3-44e7-83e9-a058d6b7d41a</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IUser_Lockout_Emails_ConfigConstants.Lockout_Email_SubjectFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Lockout_Email_Subject  {get; set;}
								/// <summary>
					/// The Lockout Email To field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 9f432906-81e8-49ff-b288-c331dd1b30f2</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IUser_Lockout_Emails_ConfigConstants.Lockout_Email_ToFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		/// </summary>
		[SitecoreType]
		public partial interface IUser_Lockout_Emails_Config__Raw : IGlassBase 
		{
										/// <summary>
						/// The Lockout Email Body field.
						/// <para></para>
						...
						/// <para>Custom Data: </para>
						/// </summary>
						[SitecoreField(IUser_Lockout_Emails_ConfigConstants.Lockout_Email_BodyFieldName, Setting = SitecoreFieldSettings.RichTextRaw)]
						string Lockout_Email_Body  {get; set;}
										/// <summary>
						/// The Lockout Email From field.
						/// <para></para>
	...
	public static partial class IUser_Lockout_Emails_ConfigConstants{

			public const string TemplateIdString = "27678fc0-f7cb-40eb-bfbf-9c226b62eece";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "User Lockout Emails Config";

					
			public static readonly ID Lockout_Email_BodyFieldId = new ID("cc904647-bac3-4fe2-8884-f6106c487670");
			public const string Lockout_Email_BodyFieldName = "Lockout Email Body";

							public static readonly ID Lockout_Email_Body__RawFieldId = new ID("cc904647-bac3-4fe2-8884-f6106c487670");
				public const string Lockout_Email_Body__RawFieldName = "Lockout Email Body";
						
					
			public static readonly ID Lockout_Email_FromFieldId = new ID("742c887c-86c6-4d36-b5cf-bb3ba50f49c4");
			public const string Lockout_Email_FromFieldName = "Lockout Email From";

						
					
			public static readonly ID Lockout_Email_SubjectFieldId = new ID("d2c6a078-8cb3-44e7-83e9-a058d6b7d41a");
			public const string Lockout_Email_SubjectFieldName = "Lockout Email Subject";

						
					
			public static readonly ID Lockout_Email_ToFieldId = new ID("9f432906-81e8-49ff-b288-c331dd1b30f2");
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers
{
 	...
 	/// <summary>
	/// ISQL_Import_Map Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Providers/SQL Import Map</para>	
	/// <para>ID: 2bba4065-aa42-4509-a750-4ac2879d06ea</para>	
	/// </summary>
	[SitecoreType(TemplateId=ISQL_Import_MapConstants.TemplateIdString)]
	public partial interface ISQL_Import_Map : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers.IBase_Import_Map
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface ISQL_Import_Map__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers.IBase_Import_Map__Raw
		{
						}
	
	public static partial class ISQL_Import_MapConstants{

			public const string TemplateIdString = "2bba4065-aa42-4509-a750-4ac2879d06ea";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "SQL Import Map";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Configuration
{
 	...
 	/// <summary>
	/// IEmail_Config Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Configuration/Email Config</para>	
	/// <para>ID: 36068aee-c4d0-4a61-9acb-755efcd2de40</para>	
	/// </summary>
	[SitecoreType(TemplateId=IEmail_ConfigConstants.TemplateIdString)]
	public partial interface IEmail_Config : IGlassBase 
	{
					...
					/// <para></para>
					/// <para>Field Type: Rich Text</para>		
					/// <para>Field ID: 23b4e9bc-9d9c-44f8-80ac-93230012f320</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IEmail_ConfigConstants.Email_A_Friend_Footer_ContentFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Email_A_Friend_Footer_Content  {get; set;}
				}
		...
		public partial interface IEmail_Config__Raw : IGlassBase 
		{
						...
						/// <para>Custom Data: </para>
						/// </summary>
						[SitecoreField(IEmail_ConfigConstants.Email_A_Friend_Footer_ContentFieldName, Setting = SitecoreFieldSettings.RichTextRaw)]
						string Email_A_Friend_Footer_Content  {get; set;}
						}
	
	public static partial class IEmail_ConfigConstants{

			public const string TemplateIdString = "36068aee-c4d0-4a61-9acb-755efcd2de40";
			public static readonly ID TemplateId = new ID(TemplateIdString);
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.Account
{
 	...
 	/// <summary>
	/// IUnsubscribe_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Account/Unsubscribe Page</para>	
	/// <para>ID: 3b13dcd4-0d45-4273-bafc-7254f8ca15b5</para>	
	/// </summary>
	[SitecoreType(TemplateId=IUnsubscribe_PageConstants.TemplateIdString)]
	public partial interface IUnsubscribe_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IUnsubscribe_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw
		{
						}
	
	public static partial class IUnsubscribe_PageConstants{

			public const string TemplateIdString = "3b13dcd4-0d45-4273-bafc-7254f8ca15b5";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Unsubscribe Page";
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Properties
{


 	/// <summary>
	/// IPathToText Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Mappings/Properties/PathToText</para>	
	/// <para>ID: 3c255ada-989b-4b8c-bdd8-42c0e74749b7</para>	
	/// </summary>
	[SitecoreType(TemplateId=IPathToTextConstants.TemplateIdString)]
	public partial interface IPathToText : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.IBase_Mapping
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IPathToText__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.IBase_Mapping__Raw
		{
						}
	
	public static partial class IPathToTextConstants{

			public const string TemplateIdString = "3c255ada-989b-4b8c-bdd8-42c0e74749b7";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "PathToText";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components
{
 	...
 	/// <summary>
	/// INewsletter_Sign_Up Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Components/Newsletter Sign up</para>	
	/// <para>ID: 3d8eb2b7-1261-43da-a426-e9e3fa40ad0e</para>	
	/// </summary>
	[SitecoreType(TemplateId=INewsletter_Sign_UpConstants.TemplateIdString)]
	public partial interface INewsletter_Sign_Up : IGlassBase 
	{
								/// <summary>
					/// The Confirmation summary field.
					/// <para></para>
					/// <para>Field Type: Multi-Line Text</para>		
					/// <para>Field ID: af314b14-759b-4163-add9-e9cffc39a79f</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(INewsletter_Sign_UpConstants.Confirmation_SummaryFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Confirmation_Summary  {get; set;}
								/// <summary>
					/// The Confirmation Text field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 44f21651-8bce-4bfe-99df-e064e480dabc</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(INewsletter_Sign_UpConstants.Confirmation_TextFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Confirmation_Text  {get; set;}
								/// <summary>
					/// The Headline text field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: e2020ea6-d28e-4296-a53d-4fdf76130e5a</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(INewsletter_Sign_UpConstants.Headline_TextFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Headline_Text  {get; set;}
								/// <summary>
					/// The Sign up button text field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 5664f1dd-289e-4d3c-bae5-6c098baf34cb</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(INewsletter_Sign_UpConstants.Sign_Up_Button_TextFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Sign_Up_Button_Text  {get; set;}
								/// <summary>
					/// The Sign up call to action field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: ec162ca7-ba9a-42ab-b736-e2abb9bd1e44</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(INewsletter_Sign_UpConstants.Sign_Up_Call_To_ActionFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Sign_Up_Call_To_Action  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface INewsletter_Sign_Up__Raw : IGlassBase 
		{
										/// <summary>
						/// The Confirmation summary field.
						/// <para></para>
	...
	public static partial class INewsletter_Sign_UpConstants{

			public const string TemplateIdString = "3d8eb2b7-1261-43da-a426-e9e3fa40ad0e";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Newsletter Sign up";

					
			public static readonly ID Confirmation_SummaryFieldId = new ID("af314b14-759b-4163-add9-e9cffc39a79f");
			public const string Confirmation_SummaryFieldName = "Confirmation summary";

						
					
			public static readonly ID Confirmation_TextFieldId = new ID("44f21651-8bce-4bfe-99df-e064e480dabc");
			public const string Confirmation_TextFieldName = "Confirmation Text";

						
					
			public static readonly ID Headline_TextFieldId = new ID("e2020ea6-d28e-4296-a53d-4fdf76130e5a");
			public const string Headline_TextFieldName = "Headline text";

						
					
			public static readonly ID Sign_Up_Button_TextFieldId = new ID("5664f1dd-289e-4d3c-bae5-6c098baf34cb");
			public const string Sign_Up_Button_TextFieldName = "Sign up button text";

						
					
			public static readonly ID Sign_Up_Call_To_ActionFieldId = new ID("ec162ca7-ba9a-42ab-b736-e2abb9bd1e44");
			public const string Sign_Up_Call_To_ActionFieldName = "Sign up call to action";
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Folders
{
 	...
 	/// <summary>
	/// ITemplate_Folder Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Folders/Template Folder</para>	
	/// <para>ID: 3d915406-97f6-4e94-ac50-b7caf468a50f</para>	
	/// </summary>
	[SitecoreType(TemplateId=ITemplate_FolderConstants.TemplateIdString)]
	public partial interface ITemplate_Folder : IGlassBase 
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface ITemplate_Folder__Raw : IGlassBase 
		{
						}
	
	public static partial class ITemplate_FolderConstants{

			public const string TemplateIdString = "3d915406-97f6-4e94-ac50-b7caf468a50f";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Template Folder";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components
{
 	...
 	/// <summary>
	/// IData_Tool_Rendering_Parameter Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Components/Data Tool Rendering Parameter</para>	
	/// <para>ID: 401b6b52-5251-49d9-bfea-e177047d84d4</para>	
	/// </summary>
	[SitecoreType(TemplateId=IData_Tool_Rendering_ParameterConstants.TemplateIdString)]
	public partial interface IData_Tool_Rendering_Parameter : IGlassBase 
	{
								/// <summary>
					/// The Show in Right Rail field.
					/// <para></para>
					/// <para>Field Type: Checkbox</para>		
					/// <para>Field ID: 9b162b58-ff4a-4065-987e-d3b3bdedf526</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IData_Tool_Rendering_ParameterConstants.Show_In_Right_RailFieldName, Setting = SitecoreFieldSettings.InferType)]
					bool Show_In_Right_Rail  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IData_Tool_Rendering_Parameter__Raw : IGlassBase 
		{
										/// <summary>
						/// The Show in Right Rail field.
						/// <para></para>
	...
	public static partial class IData_Tool_Rendering_ParameterConstants{

			public const string TemplateIdString = "401b6b52-5251-49d9-bfea-e177047d84d4";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Data Tool Rendering Parameter";

					
			public static readonly ID Show_In_Right_RailFieldId = new ID("9b162b58-ff4a-4065-987e-d3b3bdedf526");
			public const string Show_In_Right_RailFieldName = "Show in Right Rail";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Configuration
{
 	...
 	/// <summary>
	/// IDCDConfiguration Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Configuration/DCDConfiguration</para>	
	/// <para>ID: 4a364237-b3c3-43c9-88cb-41b8d11598bf</para>	
	/// </summary>
	[SitecoreType(TemplateId=IDCDConfigurationConstants.TemplateIdString)]
	public partial interface IDCDConfiguration : IGlassBase 
	{
								/// <summary>
					/// The Error Distribution List field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 4147aeff-915b-4f87-a4b9-3b26f4da2ce1</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IDCDConfigurationConstants.Error_Distribution_ListFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Error_Distribution_List  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IDCDConfiguration__Raw : IGlassBase 
		{
										/// <summary>
						/// The Error Distribution List field.
						/// <para></para>
	...
	public static partial class IDCDConfigurationConstants{

			public const string TemplateIdString = "4a364237-b3c3-43c9-88cb-41b8d11598bf";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "DCDConfiguration";

					
			public static readonly ID Error_Distribution_ListFieldId = new ID("4147aeff-915b-4f87-a4b9-3b26f4da2ce1");
			public const string Error_Distribution_ListFieldName = "Error Distribution List";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components
{
 	...
 	/// <summary>
	/// IStrategic_Transactions Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Components/Strategic Transactions</para>	
	/// <para>ID: 53eaafce-5902-4c73-9584-e7e03df920f1</para>	
	/// </summary>
	[SitecoreType(TemplateId=IStrategic_TransactionsConstants.TemplateIdString)]
	public partial interface IStrategic_Transactions : IGlassBase 
	{
								/// <summary>
					/// The Body field.
					/// <para></para>
					/// <para>Field Type: Rich Text</para>		
					/// <para>Field ID: 3447fac4-8d5a-4e5a-91e2-0a474348a237</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IStrategic_TransactionsConstants.BodyFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Body  {get; set;}
								/// <summary>
					/// The Logo field.
					/// <para></para>
					...
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 05d64be7-5c72-4fbf-a817-5fc34327d73c</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IStrategic_TransactionsConstants.Subscribe_Button_TextFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		/// </summary>
		[SitecoreType]
		public partial interface IStrategic_Transactions__Raw : IGlassBase 
		{
										/// <summary>
						/// The Body field.
						/// <para></para>
						...
						/// <para>Custom Data: </para>
						/// </summary>
						[SitecoreField(IStrategic_TransactionsConstants.BodyFieldName, Setting = SitecoreFieldSettings.RichTextRaw)]
						string Body  {get; set;}
										/// <summary>
						/// The Logo field.
						/// <para></para>
	...
	public static partial class IStrategic_TransactionsConstants{
			...
			public const string TemplateIdString = "53eaafce-5902-4c73-9584-e7e03df920f1";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Strategic Transactions";

					
			public static readonly ID BodyFieldId = new ID("3447fac4-8d5a-4e5a-91e2-0a474348a237");
			public const string BodyFieldName = "Body";

							public static readonly ID Body__RawFieldId = new ID("3447fac4-8d5a-4e5a-91e2-0a474348a237");
			...
			public static readonly ID Subscribe_Button_TextFieldId = new ID("05d64be7-5c72-4fbf-a817-5fc34327d73c");
			public const string Subscribe_Button_TextFieldName = "Subscribe Button Text";

						
					
			public static readonly ID Subscribe_Button_URLFieldId = new ID("f6f1f643-66dd-4424-9996-45d11f8bfdd7");
			public const string Subscribe_Button_URLFieldName = "Subscribe Button URL";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Configuration
{
	...
	/// <para>ID: 54885551-7e32-4154-8d91-408c4e835791</para>	
	/// </summary>
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components
{
	...
	public partial interface ITableau_Dashboard : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components.IData_Tool_Base
	{
								/// <summary>
					/// The Allow Custom Views field.
					/// <para></para>
					/// <para>Field Type: Checkbox</para>		
					/// <para>Field ID: 3dd075e3-2560-4697-8ea4-d38c9fbd48ba</para>
					/// <para>Custom Data: </para>
					/// </summary>
					...
					bool Display_Toolbars  {get; set;}
								/// <summary>
					/// The Filter field.
					/// <para>(Please enter value in key=value format )</para>
					/// <para>Field Type: Single-Line Text</para>		
		...
		/// </summary>
		[SitecoreType]
		public partial interface ITableau_Dashboard__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components.IData_Tool_Base__Raw
		{
										/// <summary>
						/// The Allow Custom Views field.
						/// <para></para>
	...
	public static partial class ITableau_DashboardConstants{
			...
			public static readonly ID Related_ArticlesFieldId = new ID("9b17a58e-112b-4a71-81a2-70f5ea7d337e");
			public const string Related_ArticlesFieldName = "Related Articles";

						
					
			public static readonly ID TaxonomyFieldId = new ID("7af498fa-b21a-40dd-8e61-a369b4aa6691");
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages
{
	...
	/// </summary>
	[SitecoreType(TemplateId=IChannelConstants.TemplateIdString)]
	public partial interface IChannel : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage, global::Informa.Models.Informa.Models.sitecore.templates.Velir.FactoryInterface.IFactoryListable, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___OpenGraph
	{
								/// <summary>
					/// The Channel Code field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 8a396deb-508e-4ca3-af22-f0372acf7134</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IChannelConstants.Channel_CodeFieldName, Setting = SitecoreFieldSettings.InferType)]
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IChannelConstants.Display_TextFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		/// </summary>
		[SitecoreType]
		public partial interface IChannel__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw, global::Informa.Models.Informa.Models.sitecore.templates.Velir.FactoryInterface.IFactoryListable__Raw, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___OpenGraph__Raw
		{
										/// <summary>
						/// The Channel Code field.
						/// <para></para>
	...
	public static partial class IChannelConstants{
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.Account
{
 	...
 	/// <summary>
	/// IMy_View_Settings_Page Interface
	/// <para></para>
	...
	public partial interface IMy_View_Settings_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage
	{
					...
					string Not_Followed_Error  {get; set;}
								/// <summary>
					/// The PublicationSubscriptionSubTitle field.
					/// <para></para>
					/// <para>Field Type: Rich Text</para>		
					/// <para>Field ID: 4c70ae50-7790-4f13-a405-cc6a37777a2b</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IMy_View_Settings_PageConstants.PublicationSubscriptionSubTitleFieldName, Setting = SitecoreFieldSettings.InferType)]
					string PublicationSubscriptionSubTitle  {get; set;}
				}
		...
		public partial interface IMy_View_Settings_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw
		{
						...
						/// <para>Custom Data: </para>
						/// </summary>
						[SitecoreField(IMy_View_Settings_PageConstants.Help_LinkFieldName, Setting = SitecoreFieldSettings.RichTextRaw)]
						string Help_Link  {get; set;}
										/// <summary>
						/// The IsFromRegistration field.
						/// <para></para>
						...
						/// <para>Custom Data: </para>
						/// </summary>
						[SitecoreField(IMy_View_Settings_PageConstants.PublicationSubscriptionSubTitleFieldName, Setting = SitecoreFieldSettings.RichTextRaw)]
						string PublicationSubscriptionSubTitle  {get; set;}
						}
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Virtual_Whiteboard
{
	...
	public static partial class IArchived_IssueConstants{
			...
			public const string TemplateIdString = "6467b31c-4196-44eb-a215-eec8f733fff8";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			...
			public static readonly ID TitleFieldId = new ID("2242e825-8258-4c3f-9fc0-3ce1420cf35a");
			public const string TitleFieldName = "Title";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Global.CustomTags
{


 	/// <summary>
	/// IGeneralTag Interface
	/// <para></para>
	...
	/// </summary>
	[SitecoreType(TemplateId=IGeneralTagConstants.TemplateIdString)]
	public partial interface IGeneralTag : IGlassBase 
	{
								/// <summary>
					/// The CustomTag field.
					/// <para></para>
					/// <para>Field Type: Multi-Line Text</para>		
					/// <para>Field ID: ad3c18f8-d9ab-4ec0-be0d-46aae0ce6cee</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IGeneralTagConstants.CustomTagFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		/// </summary>
		[SitecoreType]
		public partial interface IGeneralTag__Raw : IGlassBase 
		{
										/// <summary>
						/// The CustomTag field.
						/// <para></para>
	...
	public static partial class IGeneralTagConstants{
			...
			public static readonly ID CustomTagFieldId = new ID("ad3c18f8-d9ab-4ec0-be0d-46aae0ce6cee");
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components
{
 	...
 	/// <summary>
	/// IData_Tool_Base Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Components/Data Tool Base</para>	
	/// <para>ID: 684cce86-be62-4b1c-b65c-49821a5c7d22</para>	
	/// </summary>
	...
	public partial interface IData_Tool_Base : IGlassBase 
	{
					...
					/// <para></para>
					/// <para>Field Type: General Link</para>		
					/// <para>Field ID: 5cac4fec-ab94-495f-ada4-fe34b08ebf7b</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IData_Tool_BaseConstants.Landing_Page_LinkFieldName, Setting = SitecoreFieldSettings.InferType)]
					Link Landing_Page_Link  {get; set;}
								/// <summary>
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IData_Tool_BaseConstants.Page_SubheadingFieldName, Setting = SitecoreFieldSettings.InferType)]
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IData_Tool_BaseConstants.Page_TitleFieldName, Setting = SitecoreFieldSettings.InferType)]
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IData_Tool_BaseConstants.Tool_ExplanationFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		public partial interface IData_Tool_Base__Raw : IGlassBase 
		{
						...
						/// <para>Custom Data: </para>
						/// </summary>
						[SitecoreField(IData_Tool_BaseConstants.Tool_ExplanationFieldName, Setting = SitecoreFieldSettings.RichTextRaw)]
						string Tool_Explanation  {get; set;}
						}
	
	public static partial class IData_Tool_BaseConstants{

			public const string TemplateIdString = "684cce86-be62-4b1c-b65c-49821a5c7d22";
			public static readonly ID TemplateId = new ID(TemplateIdString);
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Objects
{
	...
	public partial interface ITaxonomy_Item : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Velir.FactoryInterface.IFactoryLinkable
	{
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ITaxonomy_ItemConstants.URLFieldName, Setting = SitecoreFieldSettings.InferType)]
					Link URL  {get; set;}
				}
	...
	public static partial class ITaxonomy_ItemConstants{
			...
			public static readonly ID URLFieldId = new ID("ce4b393c-2f58-45d1-b55f-f5485d71dfb4");
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content
{
	...
	/// IContent Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/General Content/Content</para>	
	/// <para>ID: 6e30e4d3-68be-489a-9233-1ba1cc703fd8</para>	
	/// </summary>
	[SitecoreType(TemplateId=IContentConstants.TemplateIdString)]
	public partial interface IContent : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content.IContent_Title, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content.IContent_Text, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content.IContent_Image, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content.IContent_Link
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IContent__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content.IContent_Title__Raw, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content.IContent_Text__Raw, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content.IContent_Image__Raw, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content.IContent_Link__Raw
		{
						}
	
	public static partial class IContentConstants{

			public const string TemplateIdString = "6e30e4d3-68be-489a-9233-1ba1cc703fd8";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			...
			public static readonly ID ImageFieldId = new ID("5daf7d5c-9820-4308-b80f-3567fa68e833");
			public const string ImageFieldName = "Image";

						
					
			public static readonly ID LinkFieldId = new ID("2fa5b55e-183b-4bea-817d-b758cb2bb2ee");
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content
{
 	...
 	/// <summary>
	/// IContent_Image Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/General Content/Content Image</para>	
	/// <para>ID: 727a5674-9c6e-478e-bc04-327d8aa58278</para>	
	/// </summary>
	[SitecoreType(TemplateId=IContent_ImageConstants.TemplateIdString)]
	public partial interface IContent_Image : IGlassBase 
	{
								/// <summary>
					/// The Image field.
					/// <para></para>
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IContent_ImageConstants.ImageFieldName, Setting = SitecoreFieldSettings.InferType)]
					Image Image  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IContent_Image__Raw : IGlassBase 
		{
										/// <summary>
						/// The Image field.
						/// <para></para>
	...
	public static partial class IContent_ImageConstants{

			public const string TemplateIdString = "727a5674-9c6e-478e-bc04-327d8aa58278";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Content Image";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components
{
 	...
 	/// <summary>
	/// IAMCharts_Using_Builder Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Components/AMCharts Using Builder</para>	
	...
	public partial interface IAMCharts_Using_Builder : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components.IData_Tool_Base
	{
								/// <summary>
					/// The ChartHeight field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IAMCharts_Using_BuilderConstants.PresentationFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		/// </summary>
		[SitecoreType]
		public partial interface IAMCharts_Using_Builder__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components.IData_Tool_Base__Raw
		{
										/// <summary>
						/// The ChartHeight field.
						/// <para></para>
						...
						/// <para>Custom Data: </para>
						/// </summary>
						[SitecoreField(IAMCharts_Using_BuilderConstants.PresentationFieldName, Setting = SitecoreFieldSettings.RichTextRaw)]
						string Presentation  {get; set;}
						}
	...
	public static partial class IAMCharts_Using_BuilderConstants{
			...
			public const string PresentationFieldName = "Presentation";

							public static readonly ID Presentation__RawFieldId = new ID("98e1fb53-8679-48aa-9f2d-e5a02786b2f8");
				public const string Presentation__RawFieldName = "Presentation";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Global.Style_Mapping
{
 	...
 	/// <summary>
	/// IMS_Table_Style_Folder Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Global/Style Mapping/MS Table Style Folder</para>	
	/// <para>ID: 73f5b6b9-1baa-4688-8c7b-31be9215182b</para>	
	/// </summary>
	[SitecoreType(TemplateId=IMS_Table_Style_FolderConstants.TemplateIdString)]
	public partial interface IMS_Table_Style_Folder : IGlassBase 
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IMS_Table_Style_Folder__Raw : IGlassBase 
		{
						}
	
	public static partial class IMS_Table_Style_FolderConstants{

			public const string TemplateIdString = "73f5b6b9-1baa-4688-8c7b-31be9215182b";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "MS Table Style Folder";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages
{
	...
	public partial interface ITopic_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage, global::Informa.Models.Informa.Models.sitecore.templates.Velir.FactoryInterface.IFactoryListable, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___OpenGraph
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface ITopic_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw, global::Informa.Models.Informa.Models.sitecore.templates.Velir.FactoryInterface.IFactoryListable__Raw, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___OpenGraph__Raw
		{
						}
...
namespace Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned
{
	...
	/// IDocument Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/System/Media/Unversioned/Document</para>	
	/// <para>ID: 777f0c76-d712-46ea-9f40-371acda18a1c</para>	
	/// </summary>
	[SitecoreType(TemplateId=IDocumentConstants.TemplateIdString)]
	public partial interface IDocument : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned.IFile
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IDocument__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned.IFile__Raw
		{
						}
	
	public static partial class IDocumentConstants{

			public const string TemplateIdString = "777f0c76-d712-46ea-9f40-371acda18a1c";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Document";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.Account
{
 	...
 	/// <summary>
	/// IEmail_Preferences_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Account/Email Preferences Page</para>	
	/// <para>ID: 78ef0a1b-a2d5-42b3-8a81-27d676f32fd7</para>	
	/// </summary>
	[SitecoreType(TemplateId=IEmail_Preferences_PageConstants.TemplateIdString)]
	public partial interface IEmail_Preferences_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IEmail_Preferences_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw
		{
						}
	
	public static partial class IEmail_Preferences_PageConstants{

			public const string TemplateIdString = "78ef0a1b-a2d5-42b3-8a81-27d676f32fd7";
			public static readonly ID TemplateId = new ID(TemplateIdString);
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content
{
 	...
 	/// <summary>
	/// IContent_Text Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/General Content/Content Text</para>	
	/// <para>ID: 7b44925f-dd3b-4d01-988c-94a2d4bdc71f</para>	
	/// </summary>
	[SitecoreType(TemplateId=IContent_TextConstants.TemplateIdString)]
	public partial interface IContent_Text : IGlassBase 
	{
								/// <summary>
					/// The Text field.
					/// <para></para>
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IContent_TextConstants.TextFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Text  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IContent_Text__Raw : IGlassBase 
		{
										/// <summary>
						/// The Text field.
						/// <para></para>
						...
						/// <para>Custom Data: </para>
						/// </summary>
						[SitecoreField(IContent_TextConstants.TextFieldName, Setting = SitecoreFieldSettings.RichTextRaw)]
						string Text  {get; set;}
						}
	
	public static partial class IContent_TextConstants{

			public const string TemplateIdString = "7b44925f-dd3b-4d01-988c-94a2d4bdc71f";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Content Text";
...
namespace Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned
{
	...
	/// IDocx Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/System/Media/Unversioned/Docx</para>	
	/// <para>ID: 7bb0411f-50cd-4c21-ad8f-1fcde7c3affe</para>	
	/// </summary>
	[SitecoreType(TemplateId=IDocxConstants.TemplateIdString)]
	public partial interface IDocx : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned.IDocument
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IDocx__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.System.Media.Unversioned.IDocument__Raw
		{
						}
	
	public static partial class IDocxConstants{

			public const string TemplateIdString = "7bb0411f-50cd-4c21-ad8f-1fcde7c3affe";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Docx";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages
{
 	...
 	/// <summary>
	/// IDeal_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Deal Page</para>	
	/// <para>ID: 7e2b4d51-f520-4489-8a9a-c85401f8bb39</para>	
	/// </summary>
	[SitecoreType(TemplateId=IDeal_PageConstants.TemplateIdString)]
	public partial interface IDeal_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IDeal_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw
		{
						}
	
	public static partial class IDeal_PageConstants{

			public const string TemplateIdString = "7e2b4d51-f520-4489-8a9a-c85401f8bb39";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Deal Page";
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.UrlRewrite.Templates.Action.Base
{
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Global.Style_Mapping
{
 	...
 	/// <summary>
	/// IMS_Table_Style Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Global/Style Mapping/MS Table Style</para>	
	/// <para>ID: 83ac1c97-cfd1-46b1-ad6d-c750a356f212</para>	
	/// </summary>
	[SitecoreType(TemplateId=IMS_Table_StyleConstants.TemplateIdString)]
	public partial interface IMS_Table_Style : IGlassBase 
	{
								/// <summary>
					/// The CSS Class field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 30879adb-3bc0-4933-a474-9877070e246d</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IMS_Table_StyleConstants.CSS_ClassFieldName, Setting = SitecoreFieldSettings.InferType)]
					string CSS_Class  {get; set;}
								/// <summary>
					/// The CSS Element field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 214621df-7571-4430-9e91-aecc59c54148</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IMS_Table_StyleConstants.CSS_ElementFieldName, Setting = SitecoreFieldSettings.InferType)]
					string CSS_Element  {get; set;}
								/// <summary>
					/// The Title field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 4621fcf9-0067-4345-8452-9970d007b1b2</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IMS_Table_StyleConstants.TitleFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Title  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IMS_Table_Style__Raw : IGlassBase 
		{
										/// <summary>
						/// The CSS Class field.
						/// <para></para>
	...
	public static partial class IMS_Table_StyleConstants{

			public const string TemplateIdString = "83ac1c97-cfd1-46b1-ad6d-c750a356f212";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "MS Table Style";

					
			public static readonly ID CSS_ClassFieldId = new ID("30879adb-3bc0-4933-a474-9877070e246d");
			public const string CSS_ClassFieldName = "CSS Class";

						
					
			public static readonly ID CSS_ElementFieldId = new ID("214621df-7571-4430-9e91-aecc59c54148");
			public const string CSS_ElementFieldName = "CSS Element";

						
					
			public static readonly ID TitleFieldId = new ID("4621fcf9-0067-4345-8452-9970d007b1b2");
			public const string TitleFieldName = "Title";
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Folders
{
 	...
 	/// <summary>
	/// IProperty_Folder Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Folders/Property Folder</para>	
	/// <para>ID: 8452785d-ffe7-47f3-911e-f219f5bdea3a</para>	
	/// </summary>
	[SitecoreType(TemplateId=IProperty_FolderConstants.TemplateIdString)]
	public partial interface IProperty_Folder : IGlassBase 
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IProperty_Folder__Raw : IGlassBase 
		{
						}
	
	public static partial class IProperty_FolderConstants{

			public const string TemplateIdString = "8452785d-ffe7-47f3-911e-f219f5bdea3a";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Property Folder";
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers
{
 	...
 	/// <summary>
	/// IMySQL_Import_Map Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Providers/MySQL Import Map</para>	
	/// <para>ID: 84fbb783-2320-481b-876a-256e58c43fad</para>	
	/// </summary>
	[SitecoreType(TemplateId=IMySQL_Import_MapConstants.TemplateIdString)]
	public partial interface IMySQL_Import_Map : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers.IBase_Import_Map
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IMySQL_Import_Map__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers.IBase_Import_Map__Raw
		{
						}
	
	public static partial class IMySQL_Import_MapConstants{

			public const string TemplateIdString = "84fbb783-2320-481b-876a-256e58c43fad";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "MySQL Import Map";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages
{
	...
	public partial interface IHome_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage, global::Informa.Models.Informa.Models.sitecore.templates.Velir.FactoryInterface.IFactoryListable, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___OpenGraph
	{
		...
		/// </summary>
		[SitecoreType]
		public partial interface IHome_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw, global::Informa.Models.Informa.Models.sitecore.templates.Velir.FactoryInterface.IFactoryListable__Raw, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___OpenGraph__Raw
		{
						}
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Configuration
{
	...
	/// IOption Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Configuration/Option</para>	
	/// <para>ID: 897873c8-1ebb-427c-a257-caa83eb50ad9</para>	
	/// </summary>
	[SitecoreType(TemplateId=IOptionConstants.TemplateIdString)]
	public partial interface IOption : IGlassBase 
	{
								/// <summary>
					/// The Icon field.
					/// <para></para>
					/// <para>Field Type: Image</para>		
					/// <para>Field ID: ad400dc1-6b7d-45cf-ba21-6e6f23fdc722</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IOptionConstants.IconFieldName, Setting = SitecoreFieldSettings.InferType)]
					Image Icon  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IOption__Raw : IGlassBase 
		{
										/// <summary>
						/// The Icon field.
						/// <para></para>
	...
	public static partial class IOptionConstants{

			public const string TemplateIdString = "897873c8-1ebb-427c-a257-caa83eb50ad9";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Option";

					
			public static readonly ID IconFieldId = new ID("ad400dc1-6b7d-45cf-ba21-6e6f23fdc722");
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates
{
	...
	public partial interface I___BasePage : IGlassBase
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Folders
{


 	/// <summary>
	/// IImport_Map_Folder Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Folders/Import Map Folder</para>	
	/// <para>ID: 8d3bc5bd-3f77-4eff-98ab-31b5de84f31e</para>	
	/// </summary>
	[SitecoreType(TemplateId=IImport_Map_FolderConstants.TemplateIdString)]
	public partial interface IImport_Map_Folder : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Common.IFolder
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IImport_Map_Folder__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Common.IFolder__Raw
		{
						}
	
	public static partial class IImport_Map_FolderConstants{

			public const string TemplateIdString = "8d3bc5bd-3f77-4eff-98ab-31b5de84f31e";
			public static readonly ID TemplateId = new ID(TemplateIdString);
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Emails.Components
{
	...
	public partial interface IFeatured_Content : IGlassBase 
	{
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IFeatured_ContentConstants.SummaryFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Summary  {get; set;}
								/// <summary>
					/// The Title Link field.
					/// <para></para>
					/// <para>Field Type: General Link with Search</para>		
					/// <para>Field ID: 7b7b0a88-4a15-4ca2-a484-d6611acafac2</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IFeatured_ContentConstants.Title_LinkFieldName, Setting = SitecoreFieldSettings.InferType)]
					Link Title_Link  {get; set;}
								/// <summary>
					/// The Title field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IFeatured_ContentConstants.TitleFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Title  {get; set;}
								/// <summary>
					/// The Download Link Text field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: f743817c-808b-4cad-b5b9-409a819db7c9</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IFeatured_ContentConstants.Download_Link_TextFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Download_Link_Text  {get; set;}
								/// <summary>
					/// The Download Link field.
					/// <para></para>
					/// <para>Field Type: General Link with Search</para>		
					/// <para>Field ID: 7163ac7f-e9e2-408f-a6ec-8bde5078d2d9</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IFeatured_ContentConstants.Download_LinkFieldName, Setting = SitecoreFieldSettings.InferType)]
					Link Download_Link  {get; set;}
								/// <summary>
					/// The Download Type field.
					/// <para></para>
					/// <para>Field Type: Droplist</para>		
					/// <para>Field ID: 95df58fd-9916-4ae2-abf2-30d5a8ae8144</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IFeatured_ContentConstants.Download_TypeFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Download_Type  {get; set;}
								/// <summary>
					/// The Read More Link field.
					/// <para></para>
					/// <para>Field Type: General Link with Search</para>		
					/// <para>Field ID: 35a0daa1-ac21-491a-923f-88f22ea4ef32</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IFeatured_ContentConstants.Read_More_LinkFieldName, Setting = SitecoreFieldSettings.InferType)]
					Link Read_More_Link  {get; set;}
								/// <summary>
					/// The Read More Styling field.
					/// <para></para>
					/// <para>Field Type: Droplist</para>		
					/// <para>Field ID: 59de2fa2-3c63-4287-9c3d-6102f3f61b7e</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IFeatured_ContentConstants.Read_More_StylingFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Read_More_Styling  {get; set;}
								/// <summary>
					/// The Read More Text field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 0ec4b370-65b6-4a87-a927-e3204fb4ee81</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IFeatured_ContentConstants.Read_More_TextFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Read_More_Text  {get; set;}
				}
		...
		public partial interface IFeatured_Content__Raw : IGlassBase 
		{
						...
						/// <para>Custom Data: </para>
						/// </summary>
						[SitecoreField(IFeatured_ContentConstants.SummaryFieldName, Setting = SitecoreFieldSettings.RichTextRaw)]
						string Summary  {get; set;}
										/// <summary>
						/// The Title Link field.
						/// <para></para>
	...
	public static partial class IFeatured_ContentConstants{
			...
			public static readonly ID SummaryFieldId = new ID("f089d880-b8de-4f27-99c3-2b131620ac51");
			public const string SummaryFieldName = "Summary";

							public static readonly ID Summary__RawFieldId = new ID("f089d880-b8de-4f27-99c3-2b131620ac51");
				public const string Summary__RawFieldName = "Summary";
						
					
			public static readonly ID Title_LinkFieldId = new ID("7b7b0a88-4a15-4ca2-a484-d6611acafac2");
			public const string Title_LinkFieldName = "Title Link";

						
					
			public static readonly ID TitleFieldId = new ID("a28655b8-e103-40c4-830d-6c2f65a44e32");
			public const string TitleFieldName = "Title";

						
					
			public static readonly ID Download_Link_TextFieldId = new ID("f743817c-808b-4cad-b5b9-409a819db7c9");
			public const string Download_Link_TextFieldName = "Download Link Text";

						
					
			public static readonly ID Download_LinkFieldId = new ID("7163ac7f-e9e2-408f-a6ec-8bde5078d2d9");
			public const string Download_LinkFieldName = "Download Link";

						
					
			public static readonly ID Download_TypeFieldId = new ID("95df58fd-9916-4ae2-abf2-30d5a8ae8144");
			public const string Download_TypeFieldName = "Download Type";

						
					
			public static readonly ID Read_More_LinkFieldId = new ID("35a0daa1-ac21-491a-923f-88f22ea4ef32");
			public const string Read_More_LinkFieldName = "Read More Link";

						
					
			public static readonly ID Read_More_StylingFieldId = new ID("59de2fa2-3c63-4287-9c3d-6102f3f61b7e");
			public const string Read_More_StylingFieldName = "Read More Styling";

						
					
			public static readonly ID Read_More_TextFieldId = new ID("0ec4b370-65b6-4a87-a927-e3204fb4ee81");
			public const string Read_More_TextFieldName = "Read More Text";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Virtual_Whiteboard
{
	...
	public partial interface IIssue : IGlassBase 
	{
					...
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 2242e825-8258-4c3f-9fc0-3ce1420cf35a</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IIssueConstants.TitleFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Title  {get; set;}
				}
	...
	public static partial class IIssueConstants{

			public const string TemplateIdString = "90c7c95a-2d6f-49d8-b471-7626e3135201";
			public static readonly ID TemplateId = new ID(TemplateIdString);
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings
{


 	/// <summary>
	/// IBase_Mapping Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Mappings/Base Mapping</para>	
	/// <para>ID: 91d02640-32d5-45ff-a3d2-a5b3402a36e4</para>	
	/// </summary>
	[SitecoreType(TemplateId=IBase_MappingConstants.TemplateIdString)]
	public partial interface IBase_Mapping : IGlassBase 
	{
								/// <summary>
					/// The To What Field field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 093d915a-4306-4a68-b64a-07cc2a7e4ee5</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_MappingConstants.To_What_FieldFieldName, Setting = SitecoreFieldSettings.InferType)]
					string To_What_Field  {get; set;}
								/// <summary>
					/// The Handler Assembly field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: bdf8732c-c239-4762-a3e0-ada23ef44775</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_MappingConstants.Handler_AssemblyFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Handler_Assembly  {get; set;}
								/// <summary>
					/// The Handler Class field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: fa7b99b1-6bb9-469c-b786-f8a9d52d2f0a</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_MappingConstants.Handler_ClassFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Handler_Class  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IBase_Mapping__Raw : IGlassBase 
		{
										/// <summary>
						/// The To What Field field.
						/// <para></para>
	...
	public static partial class IBase_MappingConstants{

			public const string TemplateIdString = "91d02640-32d5-45ff-a3d2-a5b3402a36e4";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Base Mapping";
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers
{
 	...
 	/// <summary>
	/// ISitecore_Import_Map Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Providers/Sitecore Import Map</para>	
	/// <para>ID: 96aac80c-ce36-43c5-93eb-eda101794aac</para>	
	/// </summary>
	[SitecoreType(TemplateId=ISitecore_Import_MapConstants.TemplateIdString)]
	public partial interface ISitecore_Import_Map : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers.IBase_Import_Map
	{
					...
					/// <para></para>
					/// <para>Field Type: Droplink</para>		
					/// <para>Field ID: f8b6f833-d85a-48e7-a17f-c926e39d9e65</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ISitecore_Import_MapConstants.Import_From_LanguageFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid Import_From_Language  {get; set;}
								/// <summary>
					/// The Recursively Fetch Children field.
					/// <para></para>
					/// <para>Field Type: Checkbox</para>		
					/// <para>Field ID: 690ae01b-8b70-4597-bdcd-6134c4f810b4</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ISitecore_Import_MapConstants.Recursively_Fetch_ChildrenFieldName, Setting = SitecoreFieldSettings.InferType)]
					bool Recursively_Fetch_Children  {get; set;}
				}
	...
	public static partial class ISitecore_Import_MapConstants{

			public const string TemplateIdString = "96aac80c-ce36-43c5-93eb-eda101794aac";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			...
			public static readonly ID Recursively_Fetch_ChildrenFieldId = new ID("690ae01b-8b70-4597-bdcd-6134c4f810b4");
			public const string Recursively_Fetch_ChildrenFieldName = "Recursively Fetch Children";
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Folders
{
 	...
 	/// <summary>
	/// IField_Folder Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Folders/Field Folder</para>	
	/// <para>ID: 98ef4356-8bfe-4f6a-a697-adfd0aad0b65</para>	
	/// </summary>
	[SitecoreType(TemplateId=IField_FolderConstants.TemplateIdString)]
	public partial interface IField_Folder : IGlassBase 
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IField_Folder__Raw : IGlassBase 
		{
						}
	
	public static partial class IField_FolderConstants{

			public const string TemplateIdString = "98ef4356-8bfe-4f6a-a697-adfd0aad0b65";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Field Folder";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Configuration
{
	...
	public partial interface ISite_Config : IGlassBase 
	{
					...
					Guid Email_Preferences_Page  {get; set;}
								/// <summary>
					/// The Enable MyView Toggle field.
					/// <para></para>
					/// <para>Field Type: Checkbox</para>		
					/// <para>Field ID: 0f9d9311-be37-47a3-bb47-0237ba3265d2</para>
					/// <para>Custom Data: </para>
					/// </summary>
					...
					I___BasePage My_Account_Page  {get; set;}
								/// <summary>
					/// The MyView Page field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: a58c32cd-9345-4710-aa06-b4f6615047ec</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ISite_ConfigConstants.MyView_PageFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid MyView_Page  {get; set;}
								/// <summary>
					/// The MyView Settings Page field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: c039ce68-6c4b-4a07-ab45-1d4f539f562d</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ISite_ConfigConstants.MyView_Settings_PageFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid MyView_Settings_Page  {get; set;}
								/// <summary>
					/// The Ad Domain field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					...
					string Newsletter_Weekly_Type  {get; set;}
								/// <summary>
					/// The Welcome Message Display Frequency field.
					/// <para></para>
					/// <para>Field Type: Integer</para>		
					/// <para>Field ID: 2bce4993-cc1f-4afd-bd50-b9404b9059d0</para>
					/// <para>Custom Data: </para>
					/// </summary>
					...
					int Welcome_Message_Display_Frequency  {get; set;}
								/// <summary>
					/// The Welcome Message FindOutMore LinkUrl field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: 4906d7ea-75a7-43ee-97f2-eeebaac59450</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ISite_ConfigConstants.Welcome_Message_FindOutMore_LinkUrlFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid Welcome_Message_FindOutMore_LinkUrl  {get; set;}
								/// <summary>
					/// The Welcome Message MyView LinkUrl field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: 3c6989d2-9af5-46b2-8c21-9ad2bfce298c</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ISite_ConfigConstants.Welcome_Message_MyView_LinkUrlFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid Welcome_Message_MyView_LinkUrl  {get; set;}
								/// <summary>
					...
					/// <para></para>
					/// <para>Field Type: Checkbox</para>		
					/// <para>Field ID: fe930ace-2d50-4de7-8990-df037e2156a9</para>
					/// <para>Custom Data: </para>
					/// </summary>
					...
					Guid Reset_Password_Page  {get; set;}
								/// <summary>
					/// The Search Index Name field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 56e146a6-cc34-4c23-9229-9d92a4cf4a51</para>
					/// <para>Custom Data: </para>
					/// </summary>
	...
	public static partial class ISite_ConfigConstants{
			...
			public static readonly ID Legacy_Brand_ActiveFieldId = new ID("fe930ace-2d50-4de7-8990-df037e2156a9");
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages
{
 	...
 	/// <summary>
	/// IRegistration_Thank_You_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Registration Thank You Page</para>	
	/// <para>ID: 9ab762e2-ca3b-476a-9ba3-1bf98b268c80</para>	
	/// </summary>
	[SitecoreType(TemplateId=IRegistration_Thank_You_PageConstants.TemplateIdString)]
	public partial interface IRegistration_Thank_You_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.IRegistration_Page
	{
								/// <summary>
					/// The Company Sub Title field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: deb975e3-e165-4444-9146-b570b7aa5312</para>
					/// <para>Custom Data: </para>
					/// </summary>
		...
		/// </summary>
		[SitecoreType]
		public partial interface IRegistration_Thank_You_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw, global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.IRegistration_Page__Raw
		{
										/// <summary>
						/// The Company Sub Title field.
						/// <para></para>
	...
	public static partial class IRegistration_Thank_You_PageConstants{
			...
			public const string TemplateIdString = "9ab762e2-ca3b-476a-9ba3-1bf98b268c80";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Registration Thank You Page";
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.UrlRewrite.Templates
{
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.Account
{
 	...
 	/// <summary>
	/// ISubscriptions_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Account/Subscriptions Page</para>	
	/// <para>ID: a5c1fc0c-f7ea-4164-b546-291d23943036</para>	
	/// </summary>
	...
	public static partial class ISubscriptions_PageConstants{
			...
			public const string TemplateIdString = "a5c1fc0c-f7ea-4164-b546-291d23943036";
			public static readonly ID TemplateId = new ID(TemplateIdString);
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Rss
{
 	...
 	/// <summary>
	/// ISearch_Rss_Feed Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Rss/Search Rss Feed</para>	
	...
	public partial interface ISearch_Rss_Feed : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Rss.I_Base_Rss_Feed
	{
					...
					/// <para></para>
					/// <para>Field Type: Checkbox</para>		
					/// <para>Field ID: 28e25d4d-6fc6-4881-a059-9464c4189015</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ISearch_Rss_FeedConstants.Include_Url_ParametersFieldName, Setting = SitecoreFieldSettings.InferType)]
					bool Include_Url_Parameters  {get; set;}
								/// <summary>
					/// The Search Page field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: ba86e0da-28ce-4f72-8893-b17746097449</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ISearch_Rss_FeedConstants.Search_PageFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid Search_Page  {get; set;}
				}
	...
	public static partial class ISearch_Rss_FeedConstants{

			public const string TemplateIdString = "a6de7b43-7cd7-4bfe-ab9b-09acba91e9b8";
			public static readonly ID TemplateId = new ID(TemplateIdString);
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Global.Style_Mapping
{
 	...
 	/// <summary>
	/// ITable_Definition Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Global/Style Mapping/Table Definition</para>	
	/// <para>ID: a988a306-6746-478c-b227-f7dfbf87b783</para>	
	/// </summary>
	[SitecoreType(TemplateId=ITable_DefinitionConstants.TemplateIdString)]
	public partial interface ITable_Definition : IGlassBase 
	{
								/// <summary>
					/// The No Of Columns For Mobile field.
					/// <para></para>
					/// <para>Field Type: Integer</para>		
					/// <para>Field ID: 91146bbf-601a-41b1-9796-89a13e05c1d2</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ITable_DefinitionConstants.No_Of_Columns_For_MobileFieldName, Setting = SitecoreFieldSettings.InferType)]
					int No_Of_Columns_For_Mobile  {get; set;}
								/// <summary>
					/// The No Of Columns field.
					/// <para></para>
					/// <para>Field Type: Integer</para>		
					/// <para>Field ID: 028a47f8-a41b-4678-a06a-c021f62741c4</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ITable_DefinitionConstants.No_Of_ColumnsFieldName, Setting = SitecoreFieldSettings.InferType)]
					int No_Of_Columns  {get; set;}
								/// <summary>
					/// The No Of Rows field.
					/// <para></para>
					/// <para>Field Type: Integer</para>		
					/// <para>Field ID: 9de87c16-380f-42b6-8f45-eeaea91d9071</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ITable_DefinitionConstants.No_Of_RowsFieldName, Setting = SitecoreFieldSettings.InferType)]
					int No_Of_Rows  {get; set;}
								/// <summary>
					/// The Table Name field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 47031f75-21cb-413d-b75d-ae40e0ab612e</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ITable_DefinitionConstants.Table_NameFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		/// </summary>
		[SitecoreType]
		public partial interface ITable_Definition__Raw : IGlassBase 
		{
										/// <summary>
						/// The No Of Columns For Mobile field.
						/// <para></para>
	...
	public static partial class ITable_DefinitionConstants{

			public const string TemplateIdString = "a988a306-6746-478c-b227-f7dfbf87b783";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Table Definition";

					
			public static readonly ID No_Of_Columns_For_MobileFieldId = new ID("91146bbf-601a-41b1-9796-89a13e05c1d2");
			public const string No_Of_Columns_For_MobileFieldName = "No Of Columns For Mobile";

						
					
			public static readonly ID No_Of_ColumnsFieldId = new ID("028a47f8-a41b-4678-a06a-c021f62741c4");
			public const string No_Of_ColumnsFieldName = "No Of Columns";

						
					
			public static readonly ID No_Of_RowsFieldId = new ID("9de87c16-380f-42b6-8f45-eeaea91d9071");
			public const string No_Of_RowsFieldName = "No Of Rows";

						
					
			public static readonly ID Table_NameFieldId = new ID("47031f75-21cb-413d-b75d-ae40e0ab612e");
			public const string Table_NameFieldName = "Table Name";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Configuration
{
 	...
 	/// <summary>
	/// IPassword_Recovery_Email_Config Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Configuration/Password Recovery Email Config</para>	
	/// <para>ID: ab2f64e7-6de6-47ca-a351-e0c55c5cdb7a</para>	
	/// </summary>
	[SitecoreType(TemplateId=IPassword_Recovery_Email_ConfigConstants.TemplateIdString)]
	public partial interface IPassword_Recovery_Email_Config : IGlassBase 
	{
								/// <summary>
					/// The Email Body field.
					/// <para></para>
					/// <para>Field Type: Rich Text</para>		
					/// <para>Field ID: a6fe8357-4b73-486e-a2f5-16cdc579c014</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IPassword_Recovery_Email_ConfigConstants.Email_BodyFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Email_Body  {get; set;}
								/// <summary>
					/// The Email From field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: c6740db7-9d9a-40fb-9565-07f1a8780645</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IPassword_Recovery_Email_ConfigConstants.Email_FromFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Email_From  {get; set;}
								/// <summary>
					/// The Email Subject field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 5ddc0c6d-20c2-496a-846c-b36743470423</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IPassword_Recovery_Email_ConfigConstants.Email_SubjectFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		/// </summary>
		[SitecoreType]
		public partial interface IPassword_Recovery_Email_Config__Raw : IGlassBase 
		{
										/// <summary>
						/// The Email Body field.
						/// <para></para>
						...
						/// <para>Custom Data: </para>
						/// </summary>
						[SitecoreField(IPassword_Recovery_Email_ConfigConstants.Email_BodyFieldName, Setting = SitecoreFieldSettings.RichTextRaw)]
						string Email_Body  {get; set;}
										/// <summary>
						/// The Email From field.
						/// <para></para>
	...
	public static partial class IPassword_Recovery_Email_ConfigConstants{

			public const string TemplateIdString = "ab2f64e7-6de6-47ca-a351-e0c55c5cdb7a";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Password Recovery Email Config";

					
			public static readonly ID Email_BodyFieldId = new ID("a6fe8357-4b73-486e-a2f5-16cdc579c014");
			public const string Email_BodyFieldName = "Email Body";

							public static readonly ID Email_Body__RawFieldId = new ID("a6fe8357-4b73-486e-a2f5-16cdc579c014");
				public const string Email_Body__RawFieldName = "Email Body";
						
					
			public static readonly ID Email_FromFieldId = new ID("c6740db7-9d9a-40fb-9565-07f1a8780645");
			public const string Email_FromFieldName = "Email From";

						
					
			public static readonly ID Email_SubjectFieldId = new ID("5ddc0c6d-20c2-496a-846c-b36743470423");
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Objects.Topics
{
	...
	public partial interface ITopic : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Objects.Navigation.INavigation_Link
	{
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ITopicConstants.Display_TextFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Display_Text  {get; set;}
								/// <summary>
					...
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ITopicConstants.Topic_CodeFieldName, Setting = SitecoreFieldSettings.InferType)]
	...
	public static partial class ITopicConstants{
			...
			public static readonly ID Display_TextFieldId = new ID("32bcc6ad-3737-498c-bdcf-b19bf18040cf");
			public const string Display_TextFieldName = "Display Text";

						
					
			public static readonly ID Topic_CodeFieldId = new ID("59d3ce76-381a-43b9-9642-9516b36a500c");
			public const string Topic_CodeFieldName = "Topic Code";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Virtual_Whiteboard
{
	...
	public partial interface IIssue_Folder : IGlassBase 
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IIssue_Folder__Raw : IGlassBase 
		{
						}
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components
{
 	...
 	/// <summary>
	/// IDCDSubscribe Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Components/DCDSubscribe</para>	
	/// <para>ID: ace638f9-a25c-4413-90a1-9cb08bb7c86b</para>	
	/// </summary>
	[SitecoreType(TemplateId=IDCDSubscribeConstants.TemplateIdString)]
	public partial interface IDCDSubscribe : IGlassBase 
	{
								/// <summary>
					/// The Contact Headline field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 4f3aee23-cd4a-4241-be70-13a33808fe83</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IDCDSubscribeConstants.Contact_HeadlineFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Contact_Headline  {get; set;}
								/// <summary>
					/// The Contact Info field.
					/// <para></para>
					/// <para>Field Type: Rich Text</para>		
					/// <para>Field ID: e23ca688-f7f2-4b7a-8d14-43dfd6653a3d</para>
					/// <para>Custom Data: </para>
					/// </summary>
		...
		/// </summary>
		[SitecoreType]
		public partial interface IDCDSubscribe__Raw : IGlassBase 
		{
										/// <summary>
						/// The Contact Headline field.
						/// <para></para>
	...
	public static partial class IDCDSubscribeConstants{
			...
			public const string TemplateIdString = "ace638f9-a25c-4413-90a1-9cb08bb7c86b";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "DCDSubscribe";

					
			public static readonly ID Contact_HeadlineFieldId = new ID("4f3aee23-cd4a-4241-be70-13a33808fe83");
			public const string Contact_HeadlineFieldName = "Contact Headline";

						
					
			public static readonly ID Contact_InfoFieldId = new ID("e23ca688-f7f2-4b7a-8d14-43dfd6653a3d");
			public const string Contact_InfoFieldName = "Contact Info";

							public static readonly ID Contact_Info__RawFieldId = new ID("e23ca688-f7f2-4b7a-8d14-43dfd6653a3d");
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.Account
{
 	...
 	/// <summary>
	/// IContact_Information_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Account/Contact Information Page</para>	
	/// <para>ID: ad6c16ac-05ce-45e4-a56b-9fca24cbaf57</para>	
	/// </summary>
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages
{
 	...
 	/// <summary>
	/// IRegistration_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Registration Page</para>	
	/// <para>ID: ad812609-c21c-42f6-a1d4-283d7699bd8a</para>	
	/// </summary>
	[SitecoreType(TemplateId=IRegistration_PageConstants.TemplateIdString)]
	public partial interface IRegistration_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IRegistration_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw
		{
						}
	
	public static partial class IRegistration_PageConstants{
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.View_Templates
{
 	...
 	/// <summary>
	/// IPromotional_Options Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/View Templates/Promotional Options</para>	
	/// <para>ID: bc8bbb26-9d07-441f-bf09-b533af03b191</para>	
	/// </summary>
	[SitecoreType(TemplateId=IPromotional_OptionsConstants.TemplateIdString)]
	public partial interface IPromotional_Options : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.View_Templates.IShow_Image_Options
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IPromotional_Options__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.View_Templates.IShow_Image_Options__Raw
		{
						}
	
	public static partial class IPromotional_OptionsConstants{

			public const string TemplateIdString = "bc8bbb26-9d07-441f-bf09-b533af03b191";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Promotional Options";
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields
{
 	...
 	/// <summary>
	/// IToStaticValue Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Mappings/Fields/ToStaticValue</para>	
	/// <para>ID: bd069a3b-1c64-4644-9d1a-f1f12cc00186</para>	
	/// </summary>
	[SitecoreType(TemplateId=IToStaticValueConstants.TemplateIdString)]
	public partial interface IToStaticValue : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.IBase_Mapping
	{
								/// <summary>
					/// The Value field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 97e16f71-04ec-4940-b73c-ebaa2bdfaedc</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IToStaticValueConstants.ValueFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Value  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IToStaticValue__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.IBase_Mapping__Raw
		{
										/// <summary>
						/// The Value field.
						/// <para></para>
	...
	public static partial class IToStaticValueConstants{

			public const string TemplateIdString = "bd069a3b-1c64-4644-9d1a-f1f12cc00186";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "ToStaticValue";

					
			public static readonly ID ValueFieldId = new ID("97e16f71-04ec-4940-b73c-ebaa2bdfaedc");
			public const string ValueFieldName = "Value";
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Templates
{


 	/// <summary>
	/// ITemplateMapping Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Mappings/Templates/TemplateMapping</para>	
	/// <para>ID: bf0ccc61-c4bf-4d26-a0e8-8f71bfe66012</para>	
	/// </summary>
	[SitecoreType(TemplateId=ITemplateMappingConstants.TemplateIdString)]
	public partial interface ITemplateMapping : IGlassBase 
	{
								/// <summary>
					/// The From What Template field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: f897d6ab-3399-4aec-b7c0-0057f14f34ad</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ITemplateMappingConstants.From_What_TemplateFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid From_What_Template  {get; set;}
								/// <summary>
					/// The To What Template field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: a49dd11f-990f-41ac-9e6d-deb92e197be2</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ITemplateMappingConstants.To_What_TemplateFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid To_What_Template  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface ITemplateMapping__Raw : IGlassBase 
		{
										/// <summary>
						/// The From What Template field.
						/// <para></para>
	...
	public static partial class ITemplateMappingConstants{

			public const string TemplateIdString = "bf0ccc61-c4bf-4d26-a0e8-8f71bfe66012";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "TemplateMapping";

					
			public static readonly ID From_What_TemplateFieldId = new ID("f897d6ab-3399-4aec-b7c0-0057f14f34ad");
			public const string From_What_TemplateFieldName = "From What Template";

						
					
			public static readonly ID To_What_TemplateFieldId = new ID("a49dd11f-990f-41ac-9e6d-deb92e197be2");
			public const string To_What_TemplateFieldName = "To What Template";
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields
{
	...
	/// IToText Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Mappings/Fields/ToText</para>	
	/// <para>ID: c1017482-5549-4245-91f6-d960de3b00e2</para>	
	/// </summary>
	[SitecoreType(TemplateId=IToTextConstants.TemplateIdString)]
	public partial interface IToText : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.IBase_Mapping
	{
								/// <summary>
					/// The Delimiter field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: ebb47640-52e2-4bc3-8231-af6fc5113da3</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IToTextConstants.DelimiterFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Delimiter  {get; set;}
								/// <summary>
					/// The From What Fields field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: a534b62b-9c6b-449f-8b88-93753efe6aec</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IToTextConstants.From_What_FieldsFieldName, Setting = SitecoreFieldSettings.InferType)]
					string From_What_Fields  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IToText__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.IBase_Mapping__Raw
		{
										/// <summary>
						/// The Delimiter field.
						/// <para></para>
	...
	public static partial class IToTextConstants{

			public const string TemplateIdString = "c1017482-5549-4245-91f6-d960de3b00e2";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "ToText";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates
{
 	...
 	/// <summary>
	/// I___OpenGraph Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Base Templates/__OpenGraph</para>	
	/// <para>ID: c8e61f64-8645-4917-892d-cde98b89e1e8</para>	
	/// </summary>
	[SitecoreType(TemplateId=I___OpenGraphConstants.TemplateIdString)]
	public partial interface I___OpenGraph : IGlassBase 
	{
								/// <summary>
					/// The og_description field.
					/// <para></para>
					/// <para>Field Type: Multi-Line Text</para>		
					/// <para>Field ID: 2237176c-baf4-415f-9ba0-8d82c3595664</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(I___OpenGraphConstants.Og_DescriptionFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Og_Description  {get; set;}
								/// <summary>
					/// The og_image field.
					/// <para></para>
					/// <para>Field Type: Image</para>		
					/// <para>Field ID: c39a6847-98cc-48fa-815e-7459bbec73a9</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(I___OpenGraphConstants.Og_ImageFieldName, Setting = SitecoreFieldSettings.InferType)]
					Image Og_Image  {get; set;}
								/// <summary>
					/// The og_title field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 76a7a327-065f-49f6-8407-c57c29f3a5ef</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(I___OpenGraphConstants.Og_TitleFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		/// </summary>
		[SitecoreType]
		public partial interface I___OpenGraph__Raw : IGlassBase 
		{
										/// <summary>
						/// The og_description field.
						/// <para></para>
	...
	public static partial class I___OpenGraphConstants{

			public const string TemplateIdString = "c8e61f64-8645-4917-892d-cde98b89e1e8";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "__OpenGraph";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.General_Content
{
 	...
 	/// <summary>
	/// IContent_Link Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/General Content/Content Link</para>	
	/// <para>ID: d67424f5-5da5-47c1-9eae-c9b8e5119def</para>	
	/// </summary>
	[SitecoreType(TemplateId=IContent_LinkConstants.TemplateIdString)]
	public partial interface IContent_Link : IGlassBase 
	{
								/// <summary>
					/// The Link field.
					/// <para></para>
					/// <para>Field Type: General Link</para>		
					/// <para>Field ID: 2fa5b55e-183b-4bea-817d-b758cb2bb2ee</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IContent_LinkConstants.LinkFieldName, Setting = SitecoreFieldSettings.InferType)]
					Link Link  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IContent_Link__Raw : IGlassBase 
		{
										/// <summary>
						/// The Link field.
						/// <para></para>
	...
	public static partial class IContent_LinkConstants{

			public const string TemplateIdString = "d67424f5-5da5-47c1-9eae-c9b8e5119def";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Content Link";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages
{
 	...
 	/// <summary>
	/// ICompany_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Company Page</para>	
	/// <para>ID: df192077-c0c3-4834-b2d7-f75e9d2aef4a</para>	
	/// </summary>
	[SitecoreType(TemplateId=ICompany_PageConstants.TemplateIdString)]
	public partial interface ICompany_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface ICompany_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw
		{
						}
	
	public static partial class ICompany_PageConstants{

			public const string TemplateIdString = "df192077-c0c3-4834-b2d7-f75e9d2aef4a";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Company Page";
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.UrlRewrite.Templates.Server_Variables
{
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.Account
{
 	...
 	/// <summary>
	/// ISubscribe_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Account/Subscribe Page</para>	
	/// <para>ID: e571e706-5d70-4c6a-934f-ecb8b7fac4ce</para>	
	/// </summary>
	[SitecoreType(TemplateId=ISubscribe_PageConstants.TemplateIdString)]
	public partial interface ISubscribe_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface ISubscribe_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw
		{
						}
	
	public static partial class ISubscribe_PageConstants{

			public const string TemplateIdString = "e571e706-5d70-4c6a-934f-ecb8b7fac4ce";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Subscribe Page";
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields
{
	...
	/// IToDate Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Mappings/Fields/ToDate</para>	
	/// <para>ID: e5ac18c6-cfde-4e63-8ae6-aed5f10eaeb2</para>	
	/// </summary>
	[SitecoreType(TemplateId=IToDateConstants.TemplateIdString)]
	public partial interface IToDate : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields.IToText
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IToDate__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields.IToText__Raw
		{
						}
	
	public static partial class IToDateConstants{

			public const string TemplateIdString = "e5ac18c6-cfde-4e63-8ae6-aed5f10eaeb2";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "ToDate";
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers
{
 	...
 	/// <summary>
	/// ICSV_Import_Map Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Providers/CSV Import Map</para>	
	/// <para>ID: e70adef9-b551-4648-9fca-3efb17b491b1</para>	
	/// </summary>
	[SitecoreType(TemplateId=ICSV_Import_MapConstants.TemplateIdString)]
	public partial interface ICSV_Import_Map : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers.IBase_Import_Map
	{
								/// <summary>
					/// The Encoding Type field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 67362e7c-1030-4e5c-b13f-1312e761f7fc</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ICSV_Import_MapConstants.Encoding_TypeFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Encoding_Type  {get; set;}
								/// <summary>
					/// The Field Delimiter field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: a8e914be-49fd-4325-a1ce-daa3148091ed</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(ICSV_Import_MapConstants.Field_DelimiterFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Field_Delimiter  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface ICSV_Import_Map__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers.IBase_Import_Map__Raw
		{
										/// <summary>
						/// The Encoding Type field.
						/// <para></para>
	...
	public static partial class ICSV_Import_MapConstants{

			public const string TemplateIdString = "e70adef9-b551-4648-9fca-3efb17b491b1";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "CSV Import Map";

					
			public static readonly ID Encoding_TypeFieldId = new ID("67362e7c-1030-4e5c-b13f-1312e761f7fc");
			public const string Encoding_TypeFieldName = "Encoding Type";

						
					
			public static readonly ID Field_DelimiterFieldId = new ID("a8e914be-49fd-4325-a1ce-daa3148091ed");
			public const string Field_DelimiterFieldName = "Field Delimiter";
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields
{
 	...
 	/// <summary>
	/// IUrlToLink Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Mappings/Fields/UrlToLink</para>	
	/// <para>ID: e929a1d8-de99-44ca-a5fb-a87db718a316</para>	
	/// </summary>
	[SitecoreType(TemplateId=IUrlToLinkConstants.TemplateIdString)]
	public partial interface IUrlToLink : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields.IToText
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IUrlToLink__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields.IToText__Raw
		{
						}
	
	public static partial class IUrlToLinkConstants{

			public const string TemplateIdString = "e929a1d8-de99-44ca-a5fb-a87db718a316";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "UrlToLink";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Configuration
{
	...
	public partial interface IVertical_Config : IGlassBase 
	{
					...
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 4a181bc9-7b01-4dd5-8ae7-952582d73665</para>
					/// <para>Custom Data: </para>
					/// </summary>
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields
{
 	...
 	/// <summary>
	/// IListToGuid Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Mappings/Fields/ListToGuid</para>	
	/// <para>ID: ec4e9590-f027-4c6f-ac08-dcabd8877f1b</para>	
	/// </summary>
	[SitecoreType(TemplateId=IListToGuidConstants.TemplateIdString)]
	public partial interface IListToGuid : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields.IToText
	{
								/// <summary>
					/// The Source List field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: 76f71014-cc36-4507-b623-9bbd2851e8ce</para>
					/// <para>Custom Data: </para>
					/// </summary>
		...
		/// </summary>
		[SitecoreType]
		public partial interface IListToGuid__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Mappings.Fields.IToText__Raw
		{
										/// <summary>
						/// The Source List field.
						/// <para></para>
	...
	public static partial class IListToGuidConstants{
			...
			public const string TemplateIdString = "ec4e9590-f027-4c6f-ac08-dcabd8877f1b";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "ListToGuid";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates
{
	...
	public partial interface I___BaseTaxonomy : IGlassBase 
	{
					...
					/// The Taxonomy field.
					/// <para></para>
					/// <para>Field Type: MultipleRootTreelist</para>		
					/// <para>Field ID: 0212fc0f-953b-461c-b4d9-b7483a4d4f1b</para>
					/// <para>Custom Data: generic=ITaxonomy_Item</para>
					/// </summary>
					[SitecoreField(I___BaseTaxonomyConstants.TaxonomyFieldName, Setting = SitecoreFieldSettings.InferType)]
					object /* UNKNOWN */ Taxonomy  {get; set;}
								/// <summary>
					/// The TaxonomyTest field.
					/// <para></para>
					/// <para>Field Type: Treelist</para>		
					/// <para>Field ID: cdc26518-3dcb-4914-9b00-8c1b4b2733a7</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(I___BaseTaxonomyConstants.TaxonomyTestsFieldName, Setting = SitecoreFieldSettings.InferType)]
					IEnumerable<IGlassBase> TaxonomyTests  {get; set;}
				}
	...
	public static partial class I___BaseTaxonomyConstants{
			...
			public static readonly ID TaxonomyFieldId = new ID("0212fc0f-953b-461c-b4d9-b7483a4d4f1b");
			public const string TaxonomyFieldName = "Taxonomy";

						
					
			public static readonly ID TaxonomyTestsFieldId = new ID("cdc26518-3dcb-4914-9b00-8c1b4b2733a7");
			public const string TaxonomyTestsFieldName = "TaxonomyTest";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components
{
 	...
 	/// <summary>
	/// IAMcharts_Dashboard Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Components/AMcharts Dashboard</para>	
	/// <para>ID: f0160f93-a592-4f61-8e4e-f8f7e1c00246</para>	
	/// </summary>
	[SitecoreType(TemplateId=IAMcharts_DashboardConstants.TemplateIdString)]
	public partial interface IAMcharts_Dashboard : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components.IData_Tool_Base
	{
								/// <summary>
					/// The CategoryField field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: f9722a63-d4a7-4b85-bc22-bb0fe5c6c444</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IAMcharts_DashboardConstants.CategoryFieldFieldName, Setting = SitecoreFieldSettings.InferType)]
					string CategoryField  {get; set;}
								/// <summary>
					/// The ChartType field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 5808558d-ac15-4692-8726-991c350de014</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IAMcharts_DashboardConstants.ChartTypeFieldName, Setting = SitecoreFieldSettings.InferType)]
					string ChartType  {get; set;}
								/// <summary>
					/// The GraphType field.
					/// <para></para>
					...
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 7018f640-6c11-46e3-a563-843b36e100a5</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IAMcharts_DashboardConstants.HeightFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Height  {get; set;}
								/// <summary>
					/// The JsonPath field.
					/// <para></para>
					/// <para>Field Type: General Link</para>		
					/// <para>Field ID: 67d813e6-5140-486c-a479-9b86c5aaa66c</para>
					/// <para>Custom Data: </para>
					/// </summary>
					...
					Link JsonPath  {get; set;}
								/// <summary>
					/// The ValueField field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: ccaf314e-0c9b-4dff-b7ca-2c2afc985531</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IAMcharts_DashboardConstants.ValueFieldFieldName, Setting = SitecoreFieldSettings.InferType)]
		...
		/// </summary>
		[SitecoreType]
		public partial interface IAMcharts_Dashboard__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Components.IData_Tool_Base__Raw
		{
										/// <summary>
						/// The CategoryField field.
						/// <para></para>
	...
	public static partial class IAMcharts_DashboardConstants{

			public const string TemplateIdString = "f0160f93-a592-4f61-8e4e-f8f7e1c00246";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "AMcharts Dashboard";
			...
			public static readonly ID ChartTypeFieldId = new ID("5808558d-ac15-4692-8726-991c350de014");
			public const string ChartTypeFieldName = "ChartType";
			...
			public static readonly ID HeightFieldId = new ID("7018f640-6c11-46e3-a563-843b36e100a5");
			public const string HeightFieldName = "Height";
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Folders
{
 	...
 	/// <summary>
	/// IData_Import_Folder Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Folders/Data Import Folder</para>	
	/// <para>ID: fae089b9-d8b8-438f-b66f-b8e6d9c1a8b1</para>	
	/// </summary>
	[SitecoreType(TemplateId=IData_Import_FolderConstants.TemplateIdString)]
	public partial interface IData_Import_Folder : IGlassBase 
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IData_Import_Folder__Raw : IGlassBase 
		{
						}
	
	public static partial class IData_Import_FolderConstants{

			public const string TemplateIdString = "fae089b9-d8b8-438f-b66f-b8e6d9c1a8b1";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Data Import Folder";
...
namespace Informa.Models.Informa.Models.sitecore.templates.User_Defined.Pages.Account
{
 	...
 	/// <summary>
	/// IAccount_Landing_Page Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/User Defined/Pages/Account/Account Landing Page</para>	
	/// <para>ID: fcb415d5-4852-4e86-b54c-0f8ed7a6852e</para>	
	/// </summary>
	[SitecoreType(TemplateId=IAccount_Landing_PageConstants.TemplateIdString)]
	public partial interface IAccount_Landing_Page : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage
	{
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IAccount_Landing_Page__Raw : IGlassBase , global::Informa.Models.Informa.Models.sitecore.templates.User_Defined.Base_Templates.I___BasePage__Raw
		{
						}
	
	public static partial class IAccount_Landing_PageConstants{

			public const string TemplateIdString = "fcb415d5-4852-4e86-b54c-0f8ed7a6852e";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Account Landing Page";

		
*********************************************
An error occured while generating code for item '/sitecore/templates/User Defined/Pages/Account/Account Landing Page'.
T4 Template: D:\INFORMA\TS3\sitecore\Informa.tds.master\Code Generation Templates\glassv3item.tt
Errors:

Running transformation: System.NullReferenceException: Object reference not set to an instance of an object.
   at Microsoft.VisualStudio.TextTemplatingDA4BDB0B164CCB8F190EE018BF1F310F71A72EF6AD8CEBE3443D779EF1E15B1A09E7B547DB17EDDB9B2A59AB08EB25B3A92932D6589F83B12754AA417C2062E0.GeneratedTextTransformation.<>c.<GetFieldsForTemplate>b__7_2(SitecoreTemplate t)
   at System.Linq.Enumerable.<SelectManyIterator>d__16`2.MoveNext()
   at System.Linq.Enumerable.WhereEnumerableIterator`1.MoveNext()
   at System.Collections.Generic.List`1.InsertRange(Int32 index, IEnumerable`1 collection)
   at Microsoft.VisualStudio.TextTemplatingDA4BDB0B164CCB8F190EE018BF1F310F71A72EF6AD8CEBE3443D779EF1E15B1A09E7B547DB17EDDB9B2A59AB08EB25B3A92932D6589F83B12754AA417C2062E0.GeneratedTextTransformation.GetFieldsForTemplate(SitecoreTemplate item, Boolean includeBases)
   at Microsoft.VisualStudio.TextTemplatingDA4BDB0B164CCB8F190EE018BF1F310F71A72EF6AD8CEBE3443D779EF1E15B1A09E7B547DB17EDDB9B2A59AB08EB25B3A92932D6589F83B12754AA417C2062E0.GeneratedTextTransformation.TransformText()
...
namespace Informa.Models.Informa.Models.sitecore.templates.Modules.Data_Import.Providers
{
 	...
 	/// <summary>
	/// IBase_Import_Map Interface
	/// <para></para>
	/// <para>Path: /sitecore/templates/Modules/Data Import/Providers/Base Import Map</para>	
	/// <para>ID: ffb11c18-4ec6-434b-ba51-c81b640539b4</para>	
	/// </summary>
	[SitecoreType(TemplateId=IBase_Import_MapConstants.TemplateIdString)]
	public partial interface IBase_Import_Map : IGlassBase 
	{
								/// <summary>
					/// The Handler Assembly field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 0639f8e7-44ab-41ce-ae67-9987baf47e96</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.Handler_AssemblyFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Handler_Assembly  {get; set;}
								/// <summary>
					/// The Handler Class field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 0790a745-13e8-44f1-aa17-469e8fc7d20e</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.Handler_ClassFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Handler_Class  {get; set;}
								/// <summary>
					/// The Import To Language field.
					/// <para></para>
					/// <para>Field Type: Droplink</para>		
					/// <para>Field ID: 56c326ef-f5da-4818-ae74-e85130b60b84</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.Import_To_LanguageFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid Import_To_Language  {get; set;}
								/// <summary>
					/// The Import To What Template field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: 8954b459-083b-446f-b8c0-40b90ce2e210</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.Import_To_What_TemplateFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid Import_To_What_Template  {get; set;}
								/// <summary>
					/// The Import To Where field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: d01499f0-1e31-4cd6-a2f4-ee17bd095ab1</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.Import_To_WhereFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid Import_To_Where  {get; set;}
								/// <summary>
					/// The Item Name Max Length field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: 02bab16b-d351-4502-a579-f3d6e0edb4f8</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.Item_Name_Max_LengthFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Item_Name_Max_Length  {get; set;}
								/// <summary>
					/// The Pull Item Name from What Fields field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: a7c05d14-ebc8-4f08-a8c7-183fab7061cc</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.Pull_Item_Name_From_What_FieldsFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Pull_Item_Name_From_What_Fields  {get; set;}
								/// <summary>
					/// The Query field.
					/// <para></para>
					/// <para>Field Type: Multi-Line Text</para>		
					/// <para>Field ID: 1f03f44c-dd3a-4148-bee7-0724310827b8</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.QueryFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Query  {get; set;}
								/// <summary>
					/// The Date Field field.
					/// <para></para>
					/// <para>Field Type: Single-Line Text</para>		
					/// <para>Field ID: b40c055b-3a62-4dd6-8cbd-88045e42f80d</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.Date_FieldFieldName, Setting = SitecoreFieldSettings.InferType)]
					string Date_Field  {get; set;}
								/// <summary>
					/// The Folder By Date field.
					/// <para></para>
					/// <para>Field Type: Checkbox</para>		
					/// <para>Field ID: 2d49a4e9-c26d-435b-9207-4a8d1e3cf044</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.Folder_By_DateFieldName, Setting = SitecoreFieldSettings.InferType)]
					bool Folder_By_Date  {get; set;}
								/// <summary>
					/// The Folder By Name field.
					/// <para></para>
					/// <para>Field Type: Checkbox</para>		
					/// <para>Field ID: 1cb87007-972b-4d25-abd1-f85107d29637</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.Folder_By_NameFieldName, Setting = SitecoreFieldSettings.InferType)]
					bool Folder_By_Name  {get; set;}
								/// <summary>
					/// The Folder Template field.
					/// <para></para>
					/// <para>Field Type: Droptree</para>		
					/// <para>Field ID: 346d949c-b439-40bf-aeca-d43b7d7639c1</para>
					/// <para>Custom Data: </para>
					/// </summary>
					[SitecoreField(IBase_Import_MapConstants.Folder_TemplateFieldName, Setting = SitecoreFieldSettings.InferType)]
					Guid Folder_Template  {get; set;}
				}
		...
		/// </summary>
		[SitecoreType]
		public partial interface IBase_Import_Map__Raw : IGlassBase 
		{
										/// <summary>
						/// The Handler Assembly field.
						/// <para></para>
	...
	public static partial class IBase_Import_MapConstants{

			public const string TemplateIdString = "ffb11c18-4ec6-434b-ba51-c81b640539b4";
			public static readonly ID TemplateId = new ID(TemplateIdString);
			public const string TemplateName = "Base Import Map";
