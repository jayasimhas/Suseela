...
namespace SitecoreTreeWalker
{
	public class SitecoreArticle
	{
		...
		public static string GetArticleGuidByArticleNumber(string articleNumber)
		{
			var sctree = new SCTree();
            sctree.Url = Constants.EDITOR_ENVIRONMENT_LOGINURL;
			return sctree.GetArticleGuidByNum(articleNumber, SitecoreUser.GetUser().Username, SitecoreUser.GetUser().Password);
		...
		public static SitecoreTree.ArticlePreviewInfo GetArticlePreviewInfo(string articleNumber)
		{
			var sctree = new SCTree();
            sctree.Url = Constants.EDITOR_ENVIRONMENT_LOGINURL;
			return sctree.GetArtPreInfo(articleNumber, SitecoreUser.GetUser().Username, SitecoreUser.GetUser().Password);
		...
		public static List<SitecoreTree.ArticlePreviewInfo> GetArticlePreviewInfo(List<Guid> guids)
		{
			var sctree = new SCTree();
            sctree.Url = Constants.EDITOR_ENVIRONMENT_LOGINURL;
			return sctree.GetArtPreInfos(guids.ToArray(), SitecoreUser.GetUser().Username, SitecoreUser.GetUser().Password).ToList();
		...
		public static int GetWordVersionNumber(string articleNumber)
		{
			var sctree = new SCTree();
            sctree.Url = Constants.EDITOR_ENVIRONMENT_LOGINURL;
			return sctree.GetWordVersionNum(articleNumber, SitecoreUser.GetUser().Username, SitecoreUser.GetUser().Password);
		}
		...
		public static int GetWordVersionNumber(Guid articleguid)
		{
			var sctree = new SCTree();
            sctree.Url = Constants.EDITOR_ENVIRONMENT_LOGINURL;
			return sctree.GetWordVersionNumByGuid(articleguid, SitecoreUser.GetUser().Username, SitecoreUser.GetUser().Password);
		}
