...
$(document)
    .ready(function() {
        ...
        * * */
        ...
        newsletterSignup.addControl('.js-newsletter-signup-submit',
            null,
        ...
        * * */
        ...
        var userRegistrationController = new FormController({
            ...
            failureCallback: function(form, response) {
                ...
                analyticsEvent($.extend(analytics_data,
                    { event_name: "registration failure", registraion_errors: errorMsg }));
            }
        });
        ...
        var userPreRegistrationController = new FormController({
            ...
            successCallback: function(form) {
                ...
                var nextStepUrl = $(form).data('forwarding-url') +
                    sep +
                ...
                analyticsEvent($.extend(analytics_data,
                    { event_name: "registration", login_register_method: loginRegisterMethod }));
        ...
        * * */
        ...
        // IITS2-312
        $('[class^=ewf-desktop-iframe] ~ [class^=ewf-mobile-iframe]')
            .each(function(index, item) {
                $(item).remove();
            });
            ...
            .on('click',
                function(e) {
                    ...
                    $(".selectivity-input .selectivity-single-select")
                        .each(function() {
                            $(this)
                                .append('<span class="selectivity-arrow"><svg class="alert__icon"><use xlink:href="/dist/img/svg-sprite.svg#sort-down-arrow"></use></svg></span>');
                        });
