...
var svg = {
    src   : config.root + "/assets/images/icons/**/*.svg",
    watch : config.root + "/assets/images/icons/**/*.svg",
    dest  : config.root + "/assets/images/",
...
// production settings
if (config.env === "prod"){
	// removed, as this is causing issues apparently
    //svg.svgmin = true;
}
