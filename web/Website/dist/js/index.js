...
(function () {
	var marketData = {
		...
		initiateCarousel: function initiateCarousel() {
...
},{"../controllers/analytics-controller":29}],23:[function(require,module,exports){
'use strict';
...
function loadLayoutOneData(data, idx) {
	...
	var seeAllTopics = data.loadMore && data.loadMore.seeAllLink ? '<a class="seeAllChannels button--filled button--outline mobview" href="' + data.loadMore.seeAllLink + '">' + data.loadMore.seeAllText + '</a>' : '';
