...
(function () {
	...
	if ($('#cockettBunker').length > 0) {
		if (typeof window.jsonCockettBunker !== 'undefined' && window.jsonCockettBunker.length !== 0) {
			...
			$('#cockettBunker').html('<div class="alert-error" style="display: block;"><svg class="alert__icon"><use xmlns:xlink=http://www.w3.org/1999/xlink" xlink:href="/dist/img/svg-sprite.svg#alert"></use></svg><p class="page-account-contact__error">Table data is not loading</p></div>');
		}
	}
})();
	...
	var fisDryBulk = {
		...
		loadDropdownData: function loadDropdownData(options) {
			...
			try {
				...
				$('.fisDryBulkTable').html('<div class="alert-error" style="display: block;"><svg class="alert__icon"><use xmlns:xlink=http://www.w3.org/1999/xlink" xlink:href="/dist/img/svg-sprite.svg#alert"></use></svg><p class="page-account-contact__error">Table data is not loading</p></div>');
			}
		},
	...
	$(document).ready(function () {
		if ($('#howeRobinsonContainer').length > 0) {
			if (typeof window.jsonHoweRobinson !== 'undefined' && window.jsonHoweRobinson.length !== 0) {
				...
				$('.howeRobinsonTable').html('<div class="alert-error" style="display: block;"><svg class="alert__icon"><use xmlns:xlink=http://www.w3.org/1999/xlink" xlink:href="/dist/img/svg-sprite.svg#alert"></use></svg><p class="page-account-contact__error">Table data is not loading</p></div>');
			}
		}
	});
})();
			...
			$.ajax({
				...
				success: function success(searchData) {
					if (searchData && searchData.length) {
						...
						$('#dryCargoBulkFixtures table').html('<div class="alert-error" style="display: block;"><svg class="alert__icon"><use xmlns:xlink=http://www.w3.org/1999/xlink" xlink:href="/dist/img/svg-sprite.svg#alert"></use></svg><p class="page-account-contact__error">Table data is not loading</p></div>');
					}
				},
				error: function error(err) {
					$('#dryCargoBulkFixtures table').html('<div class="alert-error" style="display: block;"><svg class="alert__icon"><use xmlns:xlink=http://www.w3.org/1999/xlink" xlink:href="/dist/img/svg-sprite.svg#alert"></use></svg><p class="page-account-contact__error">Table data is not loading</p></div>');
	...
	$(document).ready(function () {
		if ($('#market-data').length > 0) {
			if (typeof window.jsonBalticIndices !== 'undefined' && window.jsonBalticIndices.length !== 0) {
				...
				$('.marketDataTable').html('<div class="alert-error" style="display: block;"><svg class="alert__icon"><use xmlns:xlink=http://www.w3.org/1999/xlink" xlink:href="/dist/img/svg-sprite.svg#alert"></use></svg><p class="page-account-contact__error">Table data is not loading</p></div>');
			}
		}
	});
})();
...
(function () {
	...
	if ($('#marketDataDryCargo').length > 0) {
		if (typeof window.jsonMarketdataDryCargo !== 'undefined' && window.jsonMarketdataDryCargo.length !== 0) {
			...
			$('#marketDataDryCargo').html('<div class="alert-error" style="display: block;"><svg class="alert__icon"><use xmlns:xlink=http://www.w3.org/1999/xlink" xlink:href="/dist/img/svg-sprite.svg#alert"></use></svg><p class="page-account-contact__error">Table data is not loading</p></div>');
		}
	}
})();
	...
	var shipContainerFixtures = {
		...
		loadDropdownData: function loadDropdownData(options) {
			...
			try {
				...
				$('#shipFixtures').html('<div class="alert-error" style="display: block;"><svg class="alert__icon"><use xmlns:xlink=http://www.w3.org/1999/xlink" xlink:href="/dist/img/svg-sprite.svg#alert"></use></svg><p class="page-account-contact__error">Table data is not loading</p></div>');
			}
		},
		renderTable: function renderTable() {
			var self = this,
...
(function () {
	...
	if ($('#tankerPureChemPage').length > 0) {
		if (typeof window.currentFleetTableData !== 'undefined' && window.currentFleetTableData.length !== 0) {
			...
			$('#tankerPureChemPage').html('<div class="alert-error" style="display: block;"><svg class="alert__icon"><use xmlns:xlink=http://www.w3.org/1999/xlink" xlink:href="/dist/img/svg-sprite.svg#alert"></use></svg><p class="page-account-contact__error">Table data is not loading</p></div>');
		}
	}
	if ($('#onOrderTable').length > 0) {
		if (typeof window.onOrderTableData !== 'undefined' && window.onOrderTableData.length !== 0) {
			...
			$('#onOrderTable').html('<div class="alert-error" style="display: block;"><svg class="alert__icon"><use xmlns:xlink=http://www.w3.org/1999/xlink" xlink:href="/dist/img/svg-sprite.svg#alert"></use></svg><p class="page-account-contact__error">Table data is not loading</p></div>');
		}
	}
})();
