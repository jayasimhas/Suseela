...
(function (argument) {
	...
	$(document).on('click', '.header_salesforce_sign-in-out', function (e) {
		...
		$(document.body).append('<iframe width="1000" height="1000" src="https://ideqa-informabi.cs82.force.com/agribusiness/secur/logout.jsp" frameborder="0"></iframe>');
...
(function () {
	var marketData = {
		...
		loadTableView: function loadTableView(tableData, id) {
		...
		initiateCarousel: function initiateCarousel() {
			$('.owl-carousel').owlCarousel({
				...
				slideBy: 1,
				navText: ["<img src='/dist/img/prev-horizontal.png'/>", "<img src='/dist/img/next-horizontal.png'/>"],
				responsive: {
					0: {
						items: 4
					},
