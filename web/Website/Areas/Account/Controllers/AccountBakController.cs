...
{
    [Authorize]
    public class AccountBakController : ConnectorController
    {
        private ApplicationSignInManager _signInManager;
        private ApplicationUserManager _userManager;
        private ISitecoreService _service;

        public AccountBakController() : base("Salesforce", ID.Parse("{78D8D914-51C8-41F3-8424-021262F148B8}"))
        {
        }

        public AccountBakController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, ISitecoreService service) : base("Salesforce", ID.Parse("{78D8D914-51C8-41F3-8424-021262F148B8}"))
        {
