...
namespace Informa.Web.Models.Salesforce
{
    public class User
    {
        ...
        [Display(Name = "Intellios ID")]
        [StringLength(30)]
        public string Intellios_ID__c { get; set; }

        [Display(Name = "MP Salesperson Code")]
        [StringLength(15)]
        public string MP_Salesperson_Code__c { get; set; }

        [Display(Name = "(deprecated)donotuse")]
        public bool jigsaw_clean__js_contact_import__c { get; set; }

        [Display(Name = "(deprecated)donotuse")]
        public bool jigsaw_clean__js_lead_import__c { get; set; }
