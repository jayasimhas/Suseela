...
public class ForgotPassword extends SetupClass {
    ...
    public void loginFormDisplay(){
        ...
        homePage.loginProcess(configuration.getString("emailID")+"incorrect", configuration.getString("password"));


        String invalid = driver.findElement(By.xpath("//div[4]/div[2]/div/div[2]/form/div[1]")).getText();
        ...
        Assert.assertEquals(helper.getElementText(By.xpath("//div[4]/div[2]/div/div[2]/form/div[2]/div[1]/span")), "Forgot your password?");
    ...
    public void frontendLogin(){
        ...
        homePage.loginProcess(configuration.getString("emailID2")+"incorrect", configuration.getString("password"));
    ...
    public void singleSignOn() {
        ...
        helper.getURL(configuration.getString("Stage.Invivo"));
